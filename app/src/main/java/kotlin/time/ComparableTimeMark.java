...
public interface ComparableTimeMark extends kotlin.time.TimeMark, java.lang.Comparable<kotlin.time.ComparableTimeMark> {
    ...
    public static final class DefaultImpls {
        public static int compareTo(kotlin.time.ComparableTimeMark r2, kotlin.time.ComparableTimeMark r3) {
                java.lang.String r0 = "other"
                kotlin.jvm.internal.Intrinsics.checkNotNullParameter(r3, r0)
                long r2 = r2.mo2084minusUwyO8pc(r3)
                kotlin.time.Duration$Companion r0 = kotlin.time.Duration.Companion
                long r0 = r0.m2195getZEROUwyO8pc()
                int r2 = kotlin.time.Duration.m2091compareToLRDsOJo(r2, r0)
                return r2
        }

        public static boolean hasNotPassedNow(kotlin.time.ComparableTimeMark r0) {
                kotlin.time.TimeMark r0 = (kotlin.time.TimeMark) r0
                boolean r0 = kotlin.time.TimeMark.DefaultImpls.hasNotPassedNow(r0)
                return r0
        }

        public static boolean hasPassedNow(kotlin.time.ComparableTimeMark r0) {
                kotlin.time.TimeMark r0 = (kotlin.time.TimeMark) r0
        ...
        public static kotlin.time.ComparableTimeMark m2087minusLRDsOJo(kotlin.time.ComparableTimeMark r0, long r1) {
                long r1 = kotlin.time.Duration.m2145unaryMinusUwyO8pc(r1)
                kotlin.time.ComparableTimeMark r0 = r0.mo2085plusLRDsOJo(r1)
                return r0
        }
    }
    ...
    kotlin.time.ComparableTimeMark mo2083minusLRDsOJo(long r1);

    /* JADX INFO: renamed from: minus-UwyO8pc */
    long mo2084minusUwyO8pc(kotlin.time.ComparableTimeMark r1);

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: plus-LRDsOJo */
    kotlin.time.ComparableTimeMark mo2085plusLRDsOJo(long r1);
}
