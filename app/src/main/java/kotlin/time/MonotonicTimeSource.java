...
public final class MonotonicTimeSource implements kotlin.time.TimeSource.WithComparableMarks {
    ...
    public final long m2223adjustReading6QKq23U(long r2, long r4) {
            r1 = this;
            kotlin.time.DurationUnit r0 = kotlin.time.DurationUnit.NANOSECONDS
            long r2 = kotlin.time.LongSaturatedMathKt.m2221saturatingAddNuflL3o(r2, r0, r4)
            long r2 = kotlin.time.TimeSource.Monotonic.ValueTimeMark.m2235constructorimpl(r2)
            return r2
    }

    /* JADX INFO: renamed from: differenceBetween-fRLX17w, reason: not valid java name */
    public final long m2224differenceBetweenfRLX17w(long r2, long r4) {
            r1 = this;
            kotlin.time.DurationUnit r0 = kotlin.time.DurationUnit.NANOSECONDS
            long r2 = kotlin.time.LongSaturatedMathKt.saturatingOriginsDiff(r2, r4, r0)
            return r2
    }

    /* JADX INFO: renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m2225elapsedFrom6eNON_k(long r4) {
            r3 = this;
            long r0 = r3.read()
            kotlin.time.DurationUnit r2 = kotlin.time.DurationUnit.NANOSECONDS
            long r4 = kotlin.time.LongSaturatedMathKt.saturatingDiff(r0, r4, r2)
            return r4
    }
    ...
    public /* bridge */ /* synthetic */ kotlin.time.ComparableTimeMark markNow() {
            r2 = this;
            long r0 = r2.m2226markNowz9LOYto()
    ...
    public long m2226markNowz9LOYto() {
            r2 = this;
            long r0 = r2.read()
            long r0 = kotlin.time.TimeSource.Monotonic.ValueTimeMark.m2235constructorimpl(r0)
            return r0
    }
