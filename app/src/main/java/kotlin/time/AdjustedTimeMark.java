...
final class AdjustedTimeMark implements kotlin.time.TimeMark {
    ...
    public long mo2082elapsedNowUwyO8pc() {
            ...
            long r0 = r0.mo2082elapsedNowUwyO8pc()
    ...
    public final long m2086getAdjustmentUwyO8pc() {
            r2 = this;
    ...
    public kotlin.time.TimeMark mo2083minusLRDsOJo(long r1) {
            r0 = this;
            kotlin.time.TimeMark r1 = kotlin.time.TimeMark.DefaultImpls.m2229minusLRDsOJo(r0, r1)
            return r1
    }

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: plus-LRDsOJo */
    public kotlin.time.TimeMark mo2085plusLRDsOJo(long r5) {
            r4 = this;
            kotlin.time.AdjustedTimeMark r0 = new kotlin.time.AdjustedTimeMark
            kotlin.time.TimeMark r1 = r4.mark
            long r2 = r4.adjustment
            long r5 = kotlin.time.Duration.m2128plusLRDsOJo(r2, r5)
            r2 = 0
            r0.<init>(r1, r5, r2)
