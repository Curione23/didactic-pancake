...
public final class OptionalsKt {
    ...
    public static final <T> T getOrElse(java.util.Optional<? extends T> r1, kotlin.jvm.functions.Function0<? extends T> r2) {
            java.lang.String r0 = "<this>"
            kotlin.jvm.internal.Intrinsics.checkNotNullParameter(r1, r0)
    ...
    public static final <T, C extends java.util.Collection<? super T>> C toCollection(java.util.Optional<T> r1, C r2) {
            java.lang.String r0 = "<this>"
            kotlin.jvm.internal.Intrinsics.checkNotNullParameter(r1, r0)
