...
public final class TransformingIndexedSequence<T, R> implements kotlin.sequences.Sequence<R> {
    ...
    public static final class AnonymousClass1 implements java.util.Iterator<R>, kotlin.jvm.internal.markers.KMappedMarker {
        ...
        AnonymousClass1(kotlin.sequences.TransformingIndexedSequence<T, R> r1) {
                r0 = this;
                r0.this$0 = r1
                r0.<init>()
    ...
    public static final /* synthetic */ kotlin.sequences.Sequence access$getSequence$p(kotlin.sequences.TransformingIndexedSequence r0) {
            kotlin.sequences.Sequence<T> r0 = r0.sequence
            return r0
    }

    public static final /* synthetic */ kotlin.jvm.functions.Function2 access$getTransformer$p(kotlin.sequences.TransformingIndexedSequence r0) {
