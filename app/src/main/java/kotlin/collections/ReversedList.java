...
final class ReversedList<T> extends kotlin.collections.AbstractMutableList<T> {
    ...
    public static final class AnonymousClass1 implements java.util.ListIterator<T>, kotlin.jvm.internal.markers.KMutableListIterator {
        ...
        AnonymousClass1(kotlin.collections.ReversedList<T> r2, int r3) {
                r1 = this;
                r1.this$0 = r2
                r1.<init>()
                java.util.List r0 = kotlin.collections.ReversedList.access$getDelegate$p(r2)
                java.util.List r2 = (java.util.List) r2
                int r2 = kotlin.collections.CollectionsKt__ReversedViewsKt.access$reversePositionIndex(r2, r3)
                java.util.ListIterator r2 = r0.listIterator(r2)
                r1.delegateIterator = r2
                return
        }
        ...
        public void add(T r2) {
                ...
                r0.add(r2)
                java.util.ListIterator<T> r2 = r1.delegateIterator
                r2.previous()
                return
        }
    ...
    public static final /* synthetic */ java.util.List access$getDelegate$p(kotlin.collections.ReversedList r0) {
