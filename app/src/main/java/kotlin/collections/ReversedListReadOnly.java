...
class ReversedListReadOnly<T> extends kotlin.collections.AbstractList<T> {
    ...
    public static final class AnonymousClass1 implements java.util.ListIterator<T>, kotlin.jvm.internal.markers.KMappedMarker {
        ...
        AnonymousClass1(kotlin.collections.ReversedListReadOnly<? extends T> r2, int r3) {
                r1 = this;
                r1.this$0 = r2
                r1.<init>()
                java.util.List r0 = kotlin.collections.ReversedListReadOnly.access$getDelegate$p(r2)
    ...
    public static final /* synthetic */ java.util.List access$getDelegate$p(kotlin.collections.ReversedListReadOnly r0) {
