...
public final class TuplesKt {
    ...
    public static final <T> java.util.List<T> toList(kotlin.Pair<? extends T, ? extends T> r1) {
    ...
    public static final <T> java.util.List<T> toList(kotlin.Triple<? extends T, ? extends T, ? extends T> r2) {
            java.lang.String r0 = "<this>"
