...
public final class LinkFollowing {
    ...
    public final java.nio.file.LinkOption[] toLinkOptions(boolean r1) {
            r0 = this;
            if (r1 == 0) goto L5
            java.nio.file.LinkOption[] r1 = kotlin.io.path.LinkFollowing.followLinkOption
            goto L7
        L5:
            java.nio.file.LinkOption[] r1 = kotlin.io.path.LinkFollowing.nofollowLinkOption
        L7:
            return r1
    }

    public final java.util.Set<java.nio.file.FileVisitOption> toVisitOptions(boolean r1) {
            r0 = this;
            if (r1 == 0) goto L5
            java.util.Set<java.nio.file.FileVisitOption> r1 = kotlin.io.path.LinkFollowing.followVisitOption
            goto L7
        L5:
            java.util.Set<java.nio.file.FileVisitOption> r1 = kotlin.io.path.LinkFollowing.nofollowVisitOption
        L7:
            return r1
    }
}
