...
class PreconditionsKt__AssertionsJVMKt {
    ...
    private static final void m764assert(boolean r0) {
            return
    }

    /* JADX INFO: renamed from: assert, reason: not valid java name */
    private static final void m765assert(boolean r0, kotlin.jvm.functions.Function0<? extends java.lang.Object> r1) {
