...
public final class UMathKt {
    ...
    private static final int m1976maxJ1ME1BU(int r0, int r1) {
    ...
    private static final long m1977maxeb3DHEI(long r0, long r2) {
    ...
    private static final int m1978minJ1ME1BU(int r0, int r1) {
    ...
    private static final long m1979mineb3DHEI(long r0, long r2) {
