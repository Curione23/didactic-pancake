...
/* JADX INFO: loaded from: DroidBridge.Launcher-v0.3.9.apk:assets/components/components/MioLibPatcher.jar:javassist/bytecode/annotation/BooleanMemberValue.class */
public class BooleanMemberValue extends javassist.bytecode.annotation.MemberValue {
    int valueIndex;

    public BooleanMemberValue(int r5, javassist.bytecode.ConstPool r6) {
            r4 = this;
            r0 = r4
            r1 = 90
            r2 = r6
    ...
    public BooleanMemberValue(boolean r5, javassist.bytecode.ConstPool r6) {
            r4 = this;
            r0 = r4
            r1 = 90
            r2 = r6
    ...
    public BooleanMemberValue(javassist.bytecode.ConstPool r5) {
            r4 = this;
            r0 = r4
            r1 = 90
            r2 = r5
    ...
    public void setValue(boolean r5) {
            r4 = this;
            r0 = r4
            r1 = r4
