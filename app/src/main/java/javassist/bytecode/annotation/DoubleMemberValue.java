...
/* JADX INFO: loaded from: DroidBridge.Launcher-v0.3.9.apk:assets/components/components/MioLibPatcher.jar:javassist/bytecode/annotation/DoubleMemberValue.class */
public class DoubleMemberValue extends javassist.bytecode.annotation.MemberValue {
    int valueIndex;

    public DoubleMemberValue(int r5, javassist.bytecode.ConstPool r6) {
            r4 = this;
            r0 = r4
            r1 = 68
            r2 = r6
    ...
    public DoubleMemberValue(double r5, javassist.bytecode.ConstPool r7) {
            r4 = this;
            r0 = r4
            r1 = 68
            r2 = r7
    ...
    public DoubleMemberValue(javassist.bytecode.ConstPool r5) {
            r4 = this;
            r0 = r4
            r1 = 68
            r2 = r5
