...
/* JADX INFO: loaded from: DroidBridge.Launcher-v0.3.9.apk:assets/components/components/MioLibPatcher.jar:javassist/bytecode/ModuleInfo.class */
class ModuleInfo extends javassist.bytecode.ConstInfo {
    static final int tag = 19;
    int name;

    public ModuleInfo(int r4, int r5) {
            r3 = this;
            r0 = r3
            r1 = r5
            r0.<init>(r1)
    ...
    public ModuleInfo(java.io.DataInputStream r4, int r5) throws java.io.IOException {
            r3 = this;
            r0 = r3
            r1 = r5
            r0.<init>(r1)
    ...
    public boolean equals(java.lang.Object r4) {
            r3 = this;
            r0 = r4
            boolean r0 = r0 instanceof javassist.bytecode.ModuleInfo
            if (r0 == 0) goto L19
            r0 = r4
    ...
    public java.lang.String getModuleName(javassist.bytecode.ConstPool r4) {
            r3 = this;
            r0 = r4
            r1 = r3
            int r1 = r1.name
