...
/* JADX INFO: loaded from: DroidBridge.Launcher-v0.3.9.apk:assets/components/components/MioLibPatcher.jar:javassist/bytecode/DynamicInfo.class */
class DynamicInfo extends javassist.bytecode.ConstInfo {
    static final int tag = 17;
    int bootstrap;
    int nameAndType;

    public DynamicInfo(int r4, int r5, int r6) {
            r3 = this;
            r0 = r3
            r1 = r6
            r0.<init>(r1)
    ...
    public DynamicInfo(java.io.DataInputStream r4, int r5) throws java.io.IOException {
            r3 = this;
            r0 = r3
            r1 = r5
            r0.<init>(r1)
    ...
    public boolean equals(java.lang.Object r4) {
            r3 = this;
            r0 = r4
            boolean r0 = r0 instanceof javassist.bytecode.DynamicInfo
            if (r0 == 0) goto L28
            r0 = r4
    ...
    public int copy(javassist.bytecode.ConstPool r8, javassist.bytecode.ConstPool r9, java.util.Map<java.lang.String, java.lang.String> r10) {
            ...
            int r0 = r0.addDynamicInfo(r1, r2)
            return r0
    }
