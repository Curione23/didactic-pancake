...
/* JADX INFO: loaded from: DroidBridge.Launcher-v0.3.9.apk:assets/components/other_login/authlib-injector.jar:moe/yushi/authlibinjector/util/KeyUtils.class */
public final class KeyUtils {
    public static byte[] decodePEMPublicKey(java.lang.String r6) throws java.lang.IllegalArgumentException {
            r0 = r6
            java.lang.String r0 = moe.yushi.authlibinjector.util.IOUtils.removeNewLines(r0)
            r6 = r0
