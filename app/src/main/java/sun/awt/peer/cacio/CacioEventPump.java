...
/* JADX WARN: Classes with same name are omitted, all sources:
  DroidBridge.Launcher-v0.3.9.apk:assets/components/caciocavallo.zip:caciocavallo/cacio-shared-1.10-SNAPSHOT.jar:sun/awt/peer/cacio/CacioEventPump.class
  DroidBridge.Launcher-v0.3.9.apk:assets/components/caciocavallo/cacio-shared-1.10-SNAPSHOT.jar:sun/awt/peer/cacio/CacioEventPump.class
 */
/* JADX INFO: loaded from: DroidBridge.Launcher-v0.3.9.apk:assets/components/caciocavallo.zip:caciocavallo/cacio-shared-1.10-SNAPSHOT.jar:sun/awt/peer/cacio/CacioEventPump.class */
public abstract class CacioEventPump<ET> implements java.lang.Runnable {
    ...
    protected final void postMouseEvent(sun.awt.peer.cacio.CacioComponent r14, int r15, long r16, int r18, int r19, int r20, int r21, boolean r22) {
            r13 = this;
            r0 = r15
    ...
    protected final void postKeyEvent(sun.awt.peer.cacio.CacioComponent r11, int r12, long r13, int r15, int r16) {
            r10 = this;
    ...
    protected final void postKeyTypedEvent(sun.awt.peer.cacio.CacioComponent r11, int r12, long r13, int r15, char r16) {
            r10 = this;
            java.awt.event.KeyEvent r0 = new java.awt.event.KeyEvent
            r1 = r0
            r2 = r11
    ...
    protected final void postComponentEvent(sun.awt.peer.cacio.CacioComponent r6, int r7) {
            r5 = this;
    ...
    protected final void postPaintEvent(sun.awt.peer.cacio.CacioComponent r8, int r9, int r10, int r11, int r12, boolean r13) {
            r7 = this;
            r0 = r13
            if (r0 == 0) goto Lc
            r0 = r8
    ...
    protected final void postPaintEvent(sun.awt.peer.cacio.CacioComponent r9, int r10, int r11, int r12, int r13) {
            r8 = this;
            r0 = r8
            r1 = r9
            r2 = r10
    ...
    protected final void postFocusEvent(sun.awt.peer.cacio.CacioComponent r8, int r9, boolean r10, sun.awt.peer.cacio.CacioComponent r11) {
            r7 = this;
            r0 = 0
            r12 = r0
            r0 = r11
    ...
    protected final void postWindwoEvent(sun.awt.peer.cacio.CacioComponent r8, int r9, int r10, int r11) {
            r7 = this;
            r0 = r9
    ...
    private void postEvent(sun.awt.peer.cacio.CacioComponent r4, java.awt.AWTEvent r5) {
            r3 = this;
            r0 = r4
            r1 = r5
