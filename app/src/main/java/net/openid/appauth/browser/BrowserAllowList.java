...
public class BrowserAllowList implements net.openid.appauth.browser.BrowserMatcher {
    private java.util.List<net.openid.appauth.browser.BrowserMatcher> mBrowserMatchers;

    public BrowserAllowList(net.openid.appauth.browser.BrowserMatcher... r1) {
            r0 = this;
            r0.<init>()
