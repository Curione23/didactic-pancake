...
/* JADX WARN: Classes with same name are omitted, all sources:
  DroidBridge.Launcher-v0.3.9.apk:assets/components/caciocavallo.zip:caciocavallo/cacio-androidnw-1.10-SNAPSHOT.jar:net/java/openjdk/cacio/ctc/CTCScreen.class
  DroidBridge.Launcher-v0.3.9.apk:assets/components/caciocavallo/cacio-androidnw-1.10-SNAPSHOT.jar:net/java/openjdk/cacio/ctc/CTCScreen.class
 */
/* JADX INFO: loaded from: DroidBridge.Launcher-v0.3.9.apk:assets/components/caciocavallo.zip:caciocavallo/cacio-androidnw-1.10-SNAPSHOT.jar:net/java/openjdk/cacio/ctc/CTCScreen.class */
public class CTCScreen implements sun.awt.peer.cacio.managed.PlatformScreen {
    private java.awt.image.BufferedImage screenBuffer;
    private static net.java.openjdk.cacio.ctc.CTCScreen instance;
    private static int[] dataBufAux;

    static net.java.openjdk.cacio.ctc.CTCScreen getInstance() {
            net.java.openjdk.cacio.ctc.CTCScreen r0 = net.java.openjdk.cacio.ctc.CTCScreen.instance
            if (r0 != 0) goto L10
            net.java.openjdk.cacio.ctc.CTCScreen r0 = new net.java.openjdk.cacio.ctc.CTCScreen
            r1 = r0
            r1.<init>()
            net.java.openjdk.cacio.ctc.CTCScreen.instance = r0
        L10:
            net.java.openjdk.cacio.ctc.CTCScreen r0 = net.java.openjdk.cacio.ctc.CTCScreen.instance
            return r0
    }
    ...
    public static int[] getCurrentScreenRGB() {
            ...
            return r0
        Lb:
            int[] r0 = net.java.openjdk.cacio.ctc.CTCScreen.dataBufAux
            if (r0 != 0) goto L25
            java.awt.Dimension r0 = sun.awt.peer.cacio.managed.FullScreenWindowFactory.getScreenDimension()
            double r0 = r0.getWidth()
            int r0 = (int) r0
            java.awt.Dimension r1 = sun.awt.peer.cacio.managed.FullScreenWindowFactory.getScreenDimension()
            double r1 = r1.getHeight()
            int r1 = (int) r1
            int r0 = r0 * r1
            int[] r0 = new int[r0]
            net.java.openjdk.cacio.ctc.CTCScreen.dataBufAux = r0
        L25:
            net.java.openjdk.cacio.ctc.CTCScreen r0 = net.java.openjdk.cacio.ctc.CTCScreen.instance
            java.awt.image.BufferedImage r0 = r0.screenBuffer
            ...
            r1 = 0
            r2 = 0
            java.awt.Dimension r3 = sun.awt.peer.cacio.managed.FullScreenWindowFactory.getScreenDimension()
            double r3 = r3.getWidth()
            int r3 = (int) r3
            java.awt.Dimension r4 = sun.awt.peer.cacio.managed.FullScreenWindowFactory.getScreenDimension()
            double r4 = r4.getHeight()
            int r4 = (int) r4
            int[] r5 = net.java.openjdk.cacio.ctc.CTCScreen.dataBufAux
