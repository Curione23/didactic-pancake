...
public abstract class Lifecycle {
    ...
    public enum Event extends java.lang.Enum<androidx.lifecycle.Lifecycle.Event> {
        ...
        public static final class Companion {
            ...
            public final androidx.lifecycle.Lifecycle.Event downFrom(androidx.lifecycle.Lifecycle.State r2) {
                    r1 = this;
            ...
            @kotlin.jvm.JvmStatic
            public final androidx.lifecycle.Lifecycle.Event downTo(androidx.lifecycle.Lifecycle.State r2) {
                    r1 = this;
                    java.lang.String r0 = "state"
                    kotlin.jvm.internal.Intrinsics.checkNotNullParameter(r2, r0)
                    int[] r0 = androidx.lifecycle.Lifecycle.Event.Companion.WhenMappings.$EnumSwitchMapping$0
            ...
            @kotlin.jvm.JvmStatic
            public final androidx.lifecycle.Lifecycle.Event upFrom(androidx.lifecycle.Lifecycle.State r2) {
                    r1 = this;
                    java.lang.String r0 = "state"
                    kotlin.jvm.internal.Intrinsics.checkNotNullParameter(r2, r0)
                    int[] r0 = androidx.lifecycle.Lifecycle.Event.Companion.WhenMappings.$EnumSwitchMapping$0
            ...
            @kotlin.jvm.JvmStatic
            public final androidx.lifecycle.Lifecycle.Event upTo(androidx.lifecycle.Lifecycle.State r2) {
                    r1 = this;
                    java.lang.String r0 = "state"
                    kotlin.jvm.internal.Intrinsics.checkNotNullParameter(r2, r0)
                    int[] r0 = androidx.lifecycle.Lifecycle.Event.Companion.WhenMappings.$EnumSwitchMapping$0
