...
public class WindowCallbackWrapper implements android.view.Window.Callback {
    ...
    static class Api23Impl {
        ...
        static boolean onSearchRequested(android.view.Window.Callback r0, android.view.SearchEvent r1) {
                boolean r0 = r0.onSearchRequested(r1)
                return r0
        }

        static android.view.ActionMode onWindowStartingActionMode(android.view.Window.Callback r0, android.view.ActionMode.Callback r1, int r2) {
    ...
    public boolean onSearchRequested(android.view.SearchEvent r2) {
            r1 = this;
            android.view.Window$Callback r0 = r1.mWrapped
            boolean r2 = androidx.appcompat.view.WindowCallbackWrapper.Api23Impl.onSearchRequested(r0, r2)
            return r2
    }
    ...
    public android.view.ActionMode onWindowStartingActionMode(android.view.ActionMode.Callback r2, int r3) {
            r1 = this;
            android.view.Window$Callback r0 = r1.mWrapped
            android.view.ActionMode r2 = androidx.appcompat.view.WindowCallbackWrapper.Api23Impl.onWindowStartingActionMode(r0, r2, r3)
            return r2
    }
}
