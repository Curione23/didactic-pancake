...
public class AppCompatCheckedTextView extends android.widget.CheckedTextView implements androidx.core.widget.TintableCheckedTextView, androidx.core.view.TintableBackgroundView, androidx.appcompat.widget.EmojiCompatConfigurationView, androidx.core.widget.TintableCompoundDrawablesView {
    ...
    public AppCompatCheckedTextView(android.content.Context r1, android.util.AttributeSet r2, int r3) {
            r0 = this;
            ...
            r1.loadFromAttributes(r2, r3)
            androidx.appcompat.widget.AppCompatCheckedTextViewHelper r1 = new androidx.appcompat.widget.AppCompatCheckedTextViewHelper
            r1.<init>(r0)
            r0.mCheckedHelper = r1
            r1.loadFromAttributes(r2, r3)
    ...
    public void setCheckMarkDrawable(android.graphics.drawable.Drawable r1) {
            ...
            androidx.appcompat.widget.AppCompatCheckedTextViewHelper r1 = r0.mCheckedHelper
            if (r1 == 0) goto La
            r1.onSetCheckMarkDrawable()
        La:
            return
    }
