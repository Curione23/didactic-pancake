...
public class AppCompatTextView extends android.widget.TextView implements androidx.core.view.TintableBackgroundView, androidx.core.widget.TintableCompoundDrawablesView, androidx.core.widget.AutoSizeableTextView, androidx.appcompat.widget.EmojiCompatConfigurationView {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<androidx.appcompat.widget.AppCompatTextView> {
        ...
        public void mapProperties(android.view.inspector.PropertyMapper r4) {
                ...
                int r4 = r4.mapObject(r0, r1)
                r3.mDrawableTintModeId = r4
                r4 = 1
    ...
    public AppCompatTextView(android.content.Context r1, android.util.AttributeSet r2, int r3) {
            ...
            androidx.appcompat.widget.AppCompatEmojiTextHelper r1 = r0.getEmojiTextViewHelper()
            r1.loadFromAttributes(r2, r3)
            return
    }

    static /* synthetic */ int access$001(androidx.appcompat.widget.AppCompatTextView r0) {
    ...
    static /* synthetic */ int access$101(androidx.appcompat.widget.AppCompatTextView r0) {
    ...
    static /* synthetic */ int access$201(androidx.appcompat.widget.AppCompatTextView r0) {
            int r0 = super.getAutoSizeStepGranularity()
            return r0
    }

    static /* synthetic */ int[] access$301(androidx.appcompat.widget.AppCompatTextView r0) {
            int[] r0 = super.getAutoSizeTextAvailableSizes()
            return r0
    }

    static /* synthetic */ int access$401(androidx.appcompat.widget.AppCompatTextView r0) {
            int r0 = super.getAutoSizeTextType()
            return r0
    }

    static /* synthetic */ android.view.textclassifier.TextClassifier access$501(androidx.appcompat.widget.AppCompatTextView r0) {
