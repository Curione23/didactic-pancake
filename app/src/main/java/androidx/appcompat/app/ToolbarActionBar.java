...
class ToolbarActionBar extends androidx.appcompat.app.ActionBar {
    ...
    private class ToolbarMenuCallback implements androidx.appcompat.app.AppCompatDelegateImpl.ActionBarMenuCallback {
        ...
        public boolean onPreparePanel(int r2) {
                r1 = this;
                if (r2 != 0) goto L14
                androidx.appcompat.app.ToolbarActionBar r2 = r1.this$0
    ...
    ToolbarActionBar(androidx.appcompat.widget.Toolbar r4, java.lang.CharSequence r5, android.view.Window.Callback r6) {
            ...
            r1.<init>(r4, r2)
            r3.mDecorToolbar = r1
            java.lang.Object r2 = androidx.core.util.Preconditions.checkNotNull(r6)
            android.view.Window$Callback r2 = (android.view.Window.Callback) r2
            r3.mWindowCallback = r2
            r1.setWindowCallback(r6)
            r4.setOnMenuItemClickListener(r0)
            r1.setWindowTitle(r5)
            androidx.appcompat.app.ToolbarActionBar$ToolbarMenuCallback r4 = new androidx.appcompat.app.ToolbarActionBar$ToolbarMenuCallback
            r4.<init>(r3)
            r3.mMenuCallback = r4
            return
    }
