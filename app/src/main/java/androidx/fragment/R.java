...
public final class R {
    ...
    public static final class id {
        public static int fragment_container_view_tag = 0x7f080118;
        public static int special_effects_controller_view_tag = 0x7f080219;
        public static int visible_removing_fragment_view_tag = 0x7f0802c1;
    ...
    public static final class styleable {
        ...
        static {
                ...
                androidx.fragment.R.styleable.Fragment = r1
                int[] r0 = new int[]{r0, r2}
                androidx.fragment.R.styleable.FragmentContainerView = r0
                return
        }
