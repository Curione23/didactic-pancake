...
public final class MasterKey {
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
                ...
                androidx.security.crypto.MasterKey$KeyScheme r1 = androidx.security.crypto.MasterKey.KeyScheme.AES256_GCM     // Catch: java.lang.NoSuchFieldError -> L12
    ...
    static class Api23Impl {
        ...
        static int getUserAuthenticationValidityDurationSeconds(android.security.keystore.KeyGenParameterSpec r0) {
                int r0 = r0.getUserAuthenticationValidityDurationSeconds()
                return r0
        }

        static boolean isUserAuthenticationRequired(android.security.keystore.KeyGenParameterSpec r0) {
                boolean r0 = r0.isUserAuthenticationRequired()
                return r0
        }
    }
    ...
    static class Api28Impl {
        ...
        static boolean isStrongBoxBacked(android.security.keystore.KeyGenParameterSpec r0) {
    ...
    public static final class Builder {
        ...
        static class Api23Impl {
            ...
            static androidx.security.crypto.MasterKey build(androidx.security.crypto.MasterKey.Builder r6) throws java.security.GeneralSecurityException, java.io.IOException {
                ...
                L9:
                    ...
                    java.lang.String r0 = "build() called before setKeyGenParameterSpec or setKeyScheme."
                    r6.<init>(r0)
                    throw r6
                L11:
                    androidx.security.crypto.MasterKey$KeyScheme r0 = r6.mKeyScheme
                ...
                L74:
                    ...
                    android.security.keystore.KeyGenParameterSpec r6 = r6.mKeyGenParameterSpec
                    r1.<init>(r0, r6)
                    return r1
                L86:
                    java.lang.NullPointerException r6 = new java.lang.NullPointerException
                    java.lang.String r0 = "KeyGenParameterSpec was null after build() check"
                    r6.<init>(r0)
                    throw r6
            }

            static java.lang.String getKeystoreAlias(android.security.keystore.KeyGenParameterSpec r0) {
                    java.lang.String r0 = r0.getKeystoreAlias()
                    return r0
            }
        }
        ...
        public androidx.security.crypto.MasterKey.Builder setKeyGenParameterSpec(android.security.keystore.KeyGenParameterSpec r4) {
            ...
            L13:
                ...
                java.lang.StringBuilder r1 = r1.append(r2)
                java.lang.String r4 = androidx.security.crypto.MasterKey.Builder.Api23Impl.getKeystoreAlias(r4)
            ...
            L38:
                ...
                java.lang.String r0 = "KeyGenParamSpec set after setting a KeyScheme"
                r4.<init>(r0)
                throw r4
        }
        ...
        public androidx.security.crypto.MasterKey.Builder setKeyScheme(androidx.security.crypto.MasterKey.KeyScheme r4) {
            ...
            L12:
                java.lang.IllegalArgumentException r4 = new java.lang.IllegalArgumentException
                java.lang.String r0 = "KeyScheme set after setting a KeyGenParamSpec"
                r4.<init>(r0)
                throw r4
            L1a:
                java.lang.IllegalArgumentException r0 = new java.lang.IllegalArgumentException
        ...
        public androidx.security.crypto.MasterKey.Builder setUserAuthenticationRequired(boolean r2) {
                ...
                androidx.security.crypto.MasterKey$Builder r2 = r1.setUserAuthenticationRequired(r2, r0)
                return r2
        }
    ...
    public enum KeyScheme extends java.lang.Enum<androidx.security.crypto.MasterKey.KeyScheme> {
        ...
        public static androidx.security.crypto.MasterKey.KeyScheme valueOf(java.lang.String r1) {
                ...
                androidx.security.crypto.MasterKey$KeyScheme r1 = (androidx.security.crypto.MasterKey.KeyScheme) r1
                return r1
        }
    ...
    MasterKey(java.lang.String r1, java.lang.Object r2) {
            r0 = this;
            r0.<init>()
            r0.mKeyAlias = r1
            android.security.keystore.KeyGenParameterSpec r2 = (android.security.keystore.KeyGenParameterSpec) r2
            r0.mKeyGenParameterSpec = r2
            return
    }
    ...
    public boolean isKeyStoreBacked() {
            ...
            java.security.KeyStore r0 = java.security.KeyStore.getInstance(r0)     // Catch: java.lang.Throwable -> L11
            r1 = 0
            r0.load(r1)     // Catch: java.lang.Throwable -> L11
            java.lang.String r1 = r2.mKeyAlias     // Catch: java.lang.Throwable -> L11
            boolean r0 = r0.containsAlias(r1)     // Catch: java.lang.Throwable -> L11
            return r0
        L11:
            r0 = 0
            return r0
