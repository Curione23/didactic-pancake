...
public class UserHandleCompat {
    ...
    private static class Api24Impl {
        ...
        static android.os.UserHandle getUserHandleForUid(int r0) {
    ...
    public static android.os.UserHandle getUserHandleForUid(int r0) {
            android.os.UserHandle r0 = androidx.core.os.UserHandleCompat.Api24Impl.getUserHandleForUid(r0)
            return r0
    }
}
