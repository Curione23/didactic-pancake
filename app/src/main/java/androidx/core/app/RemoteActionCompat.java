...
public final class RemoteActionCompat implements androidx.versionedparcelable.VersionedParcelable {
    ...
    static class Api26Impl {
        ...
        static android.app.PendingIntent getActionIntent(android.app.RemoteAction r0) {
                android.app.PendingIntent r0 = r0.getActionIntent()
                return r0
        }

        static java.lang.CharSequence getContentDescription(android.app.RemoteAction r0) {
                java.lang.CharSequence r0 = r0.getContentDescription()
                return r0
        }

        static android.graphics.drawable.Icon getIcon(android.app.RemoteAction r0) {
                android.graphics.drawable.Icon r0 = r0.getIcon()
                return r0
        }

        static java.lang.CharSequence getTitle(android.app.RemoteAction r0) {
                java.lang.CharSequence r0 = r0.getTitle()
                return r0
        }

        static boolean isEnabled(android.app.RemoteAction r0) {
    ...
    static class Api28Impl {
        ...
        static boolean shouldShowIcon(android.app.RemoteAction r0) {
    ...
    public static androidx.core.app.RemoteActionCompat createFromRemoteAction(android.app.RemoteAction r5) {
            ...
            r2 = 28
            if (r1 < r2) goto L30
            boolean r5 = androidx.core.app.RemoteActionCompat.Api28Impl.shouldShowIcon(r5)
