...
public class NotificationChannelCompat {
    ...
    static class Api26Impl {
        ...
        static boolean canBypassDnd(android.app.NotificationChannel r0) {
                boolean r0 = r0.canBypassDnd()
                return r0
        }

        static boolean canShowBadge(android.app.NotificationChannel r0) {
                boolean r0 = r0.canShowBadge()
                return r0
        }
        ...
        static android.media.AudioAttributes getAudioAttributes(android.app.NotificationChannel r0) {
                android.media.AudioAttributes r0 = r0.getAudioAttributes()
                return r0
        }

        static java.lang.String getDescription(android.app.NotificationChannel r0) {
        ...
        static int getImportance(android.app.NotificationChannel r0) {
                int r0 = r0.getImportance()
                return r0
        }

        static int getLightColor(android.app.NotificationChannel r0) {
                int r0 = r0.getLightColor()
                return r0
        }

        static int getLockscreenVisibility(android.app.NotificationChannel r0) {
                int r0 = r0.getLockscreenVisibility()
                return r0
        }

        static java.lang.CharSequence getName(android.app.NotificationChannel r0) {
                java.lang.CharSequence r0 = r0.getName()
                return r0
        }

        static android.net.Uri getSound(android.app.NotificationChannel r0) {
                android.net.Uri r0 = r0.getSound()
                return r0
        }

        static long[] getVibrationPattern(android.app.NotificationChannel r0) {
                long[] r0 = r0.getVibrationPattern()
                return r0
        }
        ...
        static boolean shouldShowLights(android.app.NotificationChannel r0) {
                boolean r0 = r0.shouldShowLights()
                return r0
        }

        static boolean shouldVibrate(android.app.NotificationChannel r0) {
    ...
    static class Api29Impl {
        ...
        static boolean canBubble(android.app.NotificationChannel r0) {
    ...
    static class Api30Impl {
        ...
        static java.lang.String getConversationId(android.app.NotificationChannel r0) {
        ...
        static boolean isImportantConversation(android.app.NotificationChannel r0) {
    ...
    NotificationChannelCompat(android.app.NotificationChannel r4) {
        ...
        L71:
            int r0 = android.os.Build.VERSION.SDK_INT
            if (r0 < r1) goto L7b
            boolean r4 = androidx.core.app.NotificationChannelCompat.Api30Impl.isImportantConversation(r4)
