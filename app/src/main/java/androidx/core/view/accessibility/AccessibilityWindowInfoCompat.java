...
public class AccessibilityWindowInfoCompat {
    ...
    private static class Api21Impl {
        ...
        static android.view.accessibility.AccessibilityWindowInfo getChild(android.view.accessibility.AccessibilityWindowInfo r0, int r1) {
                android.view.accessibility.AccessibilityWindowInfo r0 = r0.getChild(r1)
                return r0
        }

        static int getChildCount(android.view.accessibility.AccessibilityWindowInfo r0) {
                int r0 = r0.getChildCount()
                return r0
        }

        static int getId(android.view.accessibility.AccessibilityWindowInfo r0) {
                int r0 = r0.getId()
                return r0
        }

        static int getLayer(android.view.accessibility.AccessibilityWindowInfo r0) {
                int r0 = r0.getLayer()
                return r0
        }

        static android.view.accessibility.AccessibilityWindowInfo getParent(android.view.accessibility.AccessibilityWindowInfo r0) {
                android.view.accessibility.AccessibilityWindowInfo r0 = r0.getParent()
                return r0
        }

        static android.view.accessibility.AccessibilityNodeInfo getRoot(android.view.accessibility.AccessibilityWindowInfo r0) {
                android.view.accessibility.AccessibilityNodeInfo r0 = r0.getRoot()
                return r0
        }

        static int getType(android.view.accessibility.AccessibilityWindowInfo r0) {
                int r0 = r0.getType()
                return r0
        }

        static boolean isAccessibilityFocused(android.view.accessibility.AccessibilityWindowInfo r0) {
                boolean r0 = r0.isAccessibilityFocused()
                return r0
        }

        static boolean isActive(android.view.accessibility.AccessibilityWindowInfo r0) {
                boolean r0 = r0.isActive()
                return r0
        }

        static boolean isFocused(android.view.accessibility.AccessibilityWindowInfo r0) {
        ...
        static android.view.accessibility.AccessibilityWindowInfo obtain(android.view.accessibility.AccessibilityWindowInfo r0) {
    ...
    private static class Api24Impl {
        ...
        static android.view.accessibility.AccessibilityNodeInfo getAnchor(android.view.accessibility.AccessibilityWindowInfo r0) {
                android.view.accessibility.AccessibilityNodeInfo r0 = r0.getAnchor()
                return r0
        }

        static java.lang.CharSequence getTitle(android.view.accessibility.AccessibilityWindowInfo r0) {
    ...
    private static class Api26Impl {
        ...
        static boolean isInPictureInPictureMode(android.view.accessibility.AccessibilityWindowInfo r0) {
    ...
    private static class Api33Impl {
        ...
        static int getDisplayId(android.view.accessibility.AccessibilityWindowInfo r0) {
        ...
        public static androidx.core.view.accessibility.AccessibilityNodeInfoCompat getRoot(java.lang.Object r0, int r1) {
                android.view.accessibility.AccessibilityWindowInfo r0 = (android.view.accessibility.AccessibilityWindowInfo) r0
                android.view.accessibility.AccessibilityNodeInfo r0 = r0.getRoot(r1)
    ...
    private static class Api34Impl {
        ...
        static android.os.LocaleList getLocales(android.view.accessibility.AccessibilityWindowInfo r0) {
    ...
    public androidx.core.view.accessibility.AccessibilityWindowInfoCompat getChild(int r2) {
            ...
            java.lang.Object r0 = r1.mInfo
            android.view.accessibility.AccessibilityWindowInfo r0 = (android.view.accessibility.AccessibilityWindowInfo) r0
            android.view.accessibility.AccessibilityWindowInfo r2 = androidx.core.view.accessibility.AccessibilityWindowInfoCompat.Api21Impl.getChild(r0, r2)
    ...
    public androidx.core.view.accessibility.AccessibilityNodeInfoCompat getRoot(int r3) {
            ...
            if (r0 < r1) goto Ld
            java.lang.Object r0 = r2.mInfo
            androidx.core.view.accessibility.AccessibilityNodeInfoCompat r3 = androidx.core.view.accessibility.AccessibilityWindowInfoCompat.Api33Impl.getRoot(r0, r3)
            return r3
        Ld:
            androidx.core.view.accessibility.AccessibilityNodeInfoCompat r3 = r2.getRoot()
            return r3
    }
    ...
    public java.lang.String toString() {
        ...
        L79:
            r1.append(r3)
            java.lang.String r1 = ", transitionTime="
            java.lang.StringBuilder r1 = r0.append(r1)
            long r2 = r5.getTransitionTimeMillis()
            r1.append(r2)
            java.lang.String r1 = ", locales="
            java.lang.StringBuilder r1 = r0.append(r1)
            androidx.core.os.LocaleListCompat r2 = r5.getLocales()
            r1.append(r2)
            r1 = 93
            r0.append(r1)
