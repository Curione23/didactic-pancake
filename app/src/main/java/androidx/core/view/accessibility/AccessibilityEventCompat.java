...
public final class AccessibilityEventCompat {
    ...
    static class Api34Impl {
        ...
        static boolean isAccessibilityDataSensitive(android.view.accessibility.AccessibilityEvent r0) {
    ...
    public static boolean isAccessibilityDataSensitive(android.view.accessibility.AccessibilityEvent r2) {
            ...
            r1 = 34
            if (r0 < r1) goto Lb
            boolean r2 = androidx.core.view.accessibility.AccessibilityEventCompat.Api34Impl.isAccessibilityDataSensitive(r2)
            return r2
        Lb:
            r2 = 0
            return r2
