...
public final class DragAndDropPermissionsCompat {
    ...
    static class Api24Impl {
        ...
        static android.view.DragAndDropPermissions requestDragAndDropPermissions(android.app.Activity r0, android.view.DragEvent r1) {
    ...
    public static androidx.core.view.DragAndDropPermissionsCompat request(android.app.Activity r0, android.view.DragEvent r1) {
            android.view.DragAndDropPermissions r0 = androidx.core.view.DragAndDropPermissionsCompat.Api24Impl.requestDragAndDropPermissions(r0, r1)
            if (r0 == 0) goto Lc
