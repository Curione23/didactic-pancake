...
public final class TypedArrayKt {
    private static final void checkAttribute(android.content.res.TypedArray r0, int r1) {
    ...
    public static final android.content.res.ColorStateList getColorStateListOrThrow(android.content.res.TypedArray r0, int r1) {
            checkAttribute(r0, r1)
    ...
    public static final android.graphics.drawable.Drawable getDrawableOrThrow(android.content.res.TypedArray r0, int r1) {
            checkAttribute(r0, r1)
    ...
    public static final android.graphics.Typeface getFontOrThrow(android.content.res.TypedArray r0, int r1) {
            checkAttribute(r0, r1)
            android.graphics.Typeface r0 = androidx.core.content.res.TypedArrayApi26ImplKt.getFont(r0, r1)
            return r0
    }
    ...
    public static final java.lang.String getStringOrThrow(android.content.res.TypedArray r0, int r1) {
            checkAttribute(r0, r1)
    ...
    public static final java.lang.CharSequence[] getTextArrayOrThrow(android.content.res.TypedArray r0, int r1) {
            checkAttribute(r0, r1)
            java.lang.CharSequence[] r0 = r0.getTextArray(r1)
            return r0
    }

    public static final java.lang.CharSequence getTextOrThrow(android.content.res.TypedArray r0, int r1) {
            checkAttribute(r0, r1)
    ...
    public static final <R> R use(android.content.res.TypedArray r0, kotlin.jvm.functions.Function1<? super android.content.res.TypedArray, ? extends R> r1) {
