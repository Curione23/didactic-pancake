...
public class ContextCompat {
    ...
    static class Api30Impl {
        ...
        static android.content.Context createAttributionContext(android.content.Context r0, java.lang.String r1) {
        ...
        static android.view.Display getDisplayOrDefault(android.content.Context r2) {
    ...
    public static android.content.Context createAttributionContext(android.content.Context r2, java.lang.String r3) {
            ...
            r1 = 30
            if (r0 < r1) goto La
            android.content.Context r2 = androidx.core.content.ContextCompat.Api30Impl.createAttributionContext(r2, r3)
        La:
            return r2
    }

    public static android.content.Context createDeviceProtectedStorageContext(android.content.Context r0) {
            android.content.Context r0 = androidx.core.content.ContextCompat.Api24Impl.createDeviceProtectedStorageContext(r0)
            return r0
    }

    private static java.io.File createFilesDir(java.io.File r4) {
            java.lang.String r0 = "Unable to create files subdir "
            java.lang.Object r1 = androidx.core.content.ContextCompat.sSync
            monitor-enter(r1)
            boolean r2 = r4.exists()     // Catch: java.lang.Throwable -> L2b
            if (r2 != 0) goto L29
            boolean r2 = r4.mkdirs()     // Catch: java.lang.Throwable -> L2b
            if (r2 == 0) goto L13
        ...
        L13:
            ...
            java.lang.String r0 = r4.getPath()     // Catch: java.lang.Throwable -> L2b
            java.lang.StringBuilder r0 = r3.append(r0)     // Catch: java.lang.Throwable -> L2b
    ...
    public static java.io.File getDataDir(android.content.Context r0) {
            java.io.File r0 = androidx.core.content.ContextCompat.Api24Impl.getDataDir(r0)
            return r0
    }
    ...
    public static android.view.Display getDisplayOrDefault(android.content.Context r2) {
            ...
            r1 = 30
            if (r0 < r1) goto Lb
            android.view.Display r2 = androidx.core.content.ContextCompat.Api30Impl.getDisplayOrDefault(r2)
            return r2
        Lb:
    ...
    public static java.lang.String getString(android.content.Context r0, int r1) {
            android.content.Context r0 = getContextForLanguage(r0)
    ...
    public static java.lang.String getSystemServiceName(android.content.Context r0, java.lang.Class<?> r1) {
            java.lang.String r0 = androidx.core.content.ContextCompat.Api23Impl.getSystemServiceName(r0, r1)
            return r0
    }

    public static boolean isDeviceProtectedStorage(android.content.Context r0) {
            boolean r0 = androidx.core.content.ContextCompat.Api24Impl.isDeviceProtectedStorage(r0)
            return r0
    }
    ...
    static java.lang.String obtainAndCheckReceiverPermission(android.content.Context r3) {
        ...
        L1e:
            ...
            java.lang.String r1 = " is required by your application to receive broadcasts, please add it to your manifest"
            java.lang.StringBuilder r0 = r0.append(r1)
            java.lang.String r0 = r0.toString()
            r3.<init>(r0)
            throw r3
