...
public final class PopupWindowCompat {
    ...
    static class Api23Impl {
        ...
        static boolean getOverlapAnchor(android.widget.PopupWindow r0) {
                boolean r0 = r0.getOverlapAnchor()
                return r0
        }

        static int getWindowLayoutType(android.widget.PopupWindow r0) {
    ...
    public static boolean getOverlapAnchor(android.widget.PopupWindow r0) {
            boolean r0 = androidx.core.widget.PopupWindowCompat.Api23Impl.getOverlapAnchor(r0)
            return r0
    }

    public static int getWindowLayoutType(android.widget.PopupWindow r0) {
            int r0 = androidx.core.widget.PopupWindowCompat.Api23Impl.getWindowLayoutType(r0)
            return r0
    }
