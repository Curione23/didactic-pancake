...
public final class LongSparseArrayKt {
    ...
    public static final class C00331<T> implements java.util.Iterator<T>, kotlin.jvm.internal.markers.KMappedMarker {
        final /* synthetic */ android.util.LongSparseArray<T> $this_valueIterator;
        private int index;

        C00331(android.util.LongSparseArray<T> r1) {
                r0 = this;
    ...
    public static final <T> boolean contains(android.util.LongSparseArray<T> r0, long r1) {
    ...
    public static final <T> boolean containsKey(android.util.LongSparseArray<T> r0, long r1) {
            int r0 = r0.indexOfKey(r1)
            if (r0 < 0) goto L8
            r0 = 1
            goto L9
    ...
    public static final <T> boolean containsValue(android.util.LongSparseArray<T> r0, T r1) {
    ...
    public static final <T> void forEach(android.util.LongSparseArray<T> r4, kotlin.jvm.functions.Function2<? super java.lang.Long, ? super T, kotlin.Unit> r5) {
            int r0 = r4.size()
            r1 = 0
        L5:
            if (r1 >= r0) goto L19
    ...
    public static final <T> T getOrDefault(android.util.LongSparseArray<T> r0, long r1, T r3) {
    ...
    public static final <T> T getOrElse(android.util.LongSparseArray<T> r0, long r1, kotlin.jvm.functions.Function0<? extends T> r3) {
            java.lang.Object r0 = r0.get(r1)
            if (r0 != 0) goto La
    ...
    public static final <T> int getSize(android.util.LongSparseArray<T> r0) {
            int r0 = r0.size()
            return r0
    }

    public static final <T> boolean isEmpty(android.util.LongSparseArray<T> r0) {
            int r0 = r0.size()
            if (r0 != 0) goto L8
            r0 = 1
            goto L9
    ...
    public static final <T> boolean isNotEmpty(android.util.LongSparseArray<T> r0) {
            int r0 = r0.size()
            if (r0 == 0) goto L8
            r0 = 1
            goto L9
    ...
    public static final <T> void putAll(android.util.LongSparseArray<T> r5, android.util.LongSparseArray<T> r6) {
            int r0 = r6.size()
            r1 = 0
        L5:
            if (r1 >= r0) goto L15
    ...
    public static final <T> boolean remove(android.util.LongSparseArray<T> r0, long r1, T r3) {
    ...
    public static final <T> void set(android.util.LongSparseArray<T> r0, long r1, T r3) {
            r0.put(r1, r3)
            return
    }
