...
public final class RangeKt {
    ...
    public static final <T extends java.lang.Comparable<? super T>> android.util.Range<T> and(android.util.Range<T> r0, android.util.Range<T> r1) {
            android.util.Range r0 = r0.intersect(r1)
            return r0
    }

    public static final <T extends java.lang.Comparable<? super T>> android.util.Range<T> plus(android.util.Range<T> r0, android.util.Range<T> r1) {
            android.util.Range r0 = r0.extend(r1)
            return r0
    }

    public static final <T extends java.lang.Comparable<? super T>> android.util.Range<T> plus(android.util.Range<T> r0, T r1) {
            android.util.Range r0 = r0.extend(r1)
            return r0
    }

    public static final <T extends java.lang.Comparable<? super T>> android.util.Range<T> rangeTo(T r1, T r2) {
    ...
    public static final <T extends java.lang.Comparable<? super T>> android.util.Range<T> toRange(kotlin.ranges.ClosedRange<T> r2) {
            android.util.Range r0 = new android.util.Range
