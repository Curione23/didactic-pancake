...
public final class PaintKt {
    public static final boolean setBlendMode(android.graphics.Paint r0, androidx.core.graphics.BlendModeCompat r1) {
            boolean r0 = androidx.core.graphics.PaintCompat.setBlendMode(r0, r1)
            return r0
    }
}
