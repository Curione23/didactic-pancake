...
public abstract class EmojiSpan extends android.text.style.ReplacementSpan {
    ...
    public int getSize(android.graphics.Paint r1, java.lang.CharSequence r2, int r3, int r4, android.graphics.Paint.FontMetricsInt r5) {
            r0 = this;
            android.graphics.Paint$FontMetricsInt r2 = r0.mTmpFontMetrics
            r1.getFontMetricsInt(r2)
            android.graphics.Paint$FontMetricsInt r1 = r0.mTmpFontMetrics
            int r1 = r1.descent
            android.graphics.Paint$FontMetricsInt r2 = r0.mTmpFontMetrics
            int r2 = r2.ascent
            int r1 = r1 - r2
            ...
            float r1 = r1 * r2
            androidx.emoji2.text.TypefaceEmojiRasterizer r2 = r0.mRasterizer
            int r2 = r2.getHeight()
            float r2 = (float) r2
            float r1 = r1 / r2
            r0.mRatio = r1
            androidx.emoji2.text.TypefaceEmojiRasterizer r1 = r0.mRasterizer
            int r1 = r1.getHeight()
            float r1 = (float) r1
            float r2 = r0.mRatio
            float r1 = r1 * r2
