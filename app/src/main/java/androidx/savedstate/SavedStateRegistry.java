...
public final class SavedStateRegistry {
    ...
    public final void performAttach$savedstate_release(androidx.lifecycle.Lifecycle r2) {
            r1 = this;
    ...
    public final void performRestore$savedstate_release(android.os.Bundle r2) {
            r1 = this;
            boolean r0 = r1.attached
            if (r0 == 0) goto L24
            boolean r0 = r1.isRestored
