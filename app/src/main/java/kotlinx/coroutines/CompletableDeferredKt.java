...
public final class CompletableDeferredKt {
    public static final <T> kotlinx.coroutines.CompletableDeferred<T> CompletableDeferred(T r2) {
    ...
    public static final <T> boolean completeWith(kotlinx.coroutines.CompletableDeferred<T> r1, java.lang.Object r2) {
            java.lang.Throwable r0 = kotlin.Result.m770exceptionOrNullimpl(r2)
            if (r0 != 0) goto Lb
