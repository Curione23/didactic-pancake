...
final class SelectAwaitOnCompletion<T, R> extends kotlinx.coroutines.JobNode {
    ...
    public void invoke2(java.lang.Throwable r3) {
            r2 = this;
            kotlinx.coroutines.selects.SelectInstance<R> r3 = r2.select
            boolean r3 = r3.trySelect()
            if (r3 == 0) goto L13
            kotlinx.coroutines.JobSupport r3 = r2.getJob()
            kotlinx.coroutines.selects.SelectInstance<R> r0 = r2.select
            kotlin.jvm.functions.Function2<T, kotlin.coroutines.Continuation<? super R>, java.lang.Object> r1 = r2.block
            r3.selectAwaitCompletion$kotlinx_coroutines_core(r0, r1)
        L13:
            return
    }
}
