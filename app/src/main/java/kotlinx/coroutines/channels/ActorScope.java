...
public interface ActorScope<E> extends kotlinx.coroutines.CoroutineScope, kotlinx.coroutines.channels.ReceiveChannel<E> {
    ...
    public static final class DefaultImpls {
        ...
        public static /* synthetic */ void cancel(kotlinx.coroutines.channels.ActorScope r0) {
                kotlinx.coroutines.channels.ReceiveChannel r0 = (kotlinx.coroutines.channels.ReceiveChannel) r0
                kotlinx.coroutines.channels.ReceiveChannel.DefaultImpls.cancel(r0)
                return
        }

        public static <E> kotlinx.coroutines.selects.SelectClause1<E> getOnReceiveOrNull(kotlinx.coroutines.channels.ActorScope<E> r0) {
                kotlinx.coroutines.channels.ReceiveChannel r0 = (kotlinx.coroutines.channels.ReceiveChannel) r0
        ...
        public static <E> E poll(kotlinx.coroutines.channels.ActorScope<E> r0) {
                kotlinx.coroutines.channels.ReceiveChannel r0 = (kotlinx.coroutines.channels.ReceiveChannel) r0
        ...
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ActorScope<E> r0, kotlin.coroutines.Continuation<? super E> r1) {
                kotlinx.coroutines.channels.ReceiveChannel r0 = (kotlinx.coroutines.channels.ReceiveChannel) r0
