...
public interface Channel<E> extends kotlinx.coroutines.channels.SendChannel<E>, kotlinx.coroutines.channels.ReceiveChannel<E> {
    ...
    public static final class DefaultImpls {
        ...
        public static /* synthetic */ void cancel(kotlinx.coroutines.channels.Channel r0) {
                kotlinx.coroutines.channels.ReceiveChannel r0 = (kotlinx.coroutines.channels.ReceiveChannel) r0
                kotlinx.coroutines.channels.ReceiveChannel.DefaultImpls.cancel(r0)
                return
        }

        public static <E> kotlinx.coroutines.selects.SelectClause1<E> getOnReceiveOrNull(kotlinx.coroutines.channels.Channel<E> r0) {
                kotlinx.coroutines.channels.ReceiveChannel r0 = (kotlinx.coroutines.channels.ReceiveChannel) r0
        ...
        public static <E> boolean offer(kotlinx.coroutines.channels.Channel<E> r0, E r1) {
                kotlinx.coroutines.channels.SendChannel r0 = (kotlinx.coroutines.channels.SendChannel) r0
                boolean r0 = kotlinx.coroutines.channels.SendChannel.DefaultImpls.offer(r0, r1)
                return r0
        }
        ...
        public static <E> E poll(kotlinx.coroutines.channels.Channel<E> r0) {
                kotlinx.coroutines.channels.ReceiveChannel r0 = (kotlinx.coroutines.channels.ReceiveChannel) r0
        ...
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.Channel<E> r0, kotlin.coroutines.Continuation<? super E> r1) {
                kotlinx.coroutines.channels.ReceiveChannel r0 = (kotlinx.coroutines.channels.ReceiveChannel) r0
    ...
    public static final class Factory {
        ...
        static {
                ...
                java.lang.String r2 = "kotlinx.coroutines.channels.defaultBuffer"
                r3 = 64
