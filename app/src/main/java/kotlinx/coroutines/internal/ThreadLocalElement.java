...
public final class ThreadLocalElement<T> implements kotlinx.coroutines.ThreadContextElement<T> {
    ...
    public ThreadLocalElement(T r1, java.lang.ThreadLocal<T> r2) {
            r0 = this;
            r0.<init>()
            r0.value = r1
            r0.threadLocal = r2
    ...
    public <R> R fold(R r1, kotlin.jvm.functions.Function2<? super R, ? super kotlin.coroutines.CoroutineContext.Element, ? extends R> r2) {
            r0 = this;
            java.lang.Object r1 = kotlinx.coroutines.ThreadContextElement.DefaultImpls.fold(r0, r1, r2)
            return r1
    }
    ...
    public kotlin.coroutines.CoroutineContext plus(kotlin.coroutines.CoroutineContext r1) {
            r0 = this;
            kotlin.coroutines.CoroutineContext r1 = kotlinx.coroutines.ThreadContextElement.DefaultImpls.plus(r0, r1)
            return r1
    }

    @Override // kotlinx.coroutines.ThreadContextElement
    public void restoreThreadContext(kotlin.coroutines.CoroutineContext r1, T r2) {
            r0 = this;
            java.lang.ThreadLocal<T> r1 = r0.threadLocal
            r1.set(r2)
            return
    }
    ...
    @Override // kotlinx.coroutines.ThreadContextElement
    public T updateThreadContext(kotlin.coroutines.CoroutineContext r3) {
            r2 = this;
            java.lang.ThreadLocal<T> r3 = r2.threadLocal
            java.lang.Object r3 = r3.get()
            java.lang.ThreadLocal<T> r0 = r2.threadLocal
            T r1 = r2.value
            r0.set(r1)
            return r3
    }
