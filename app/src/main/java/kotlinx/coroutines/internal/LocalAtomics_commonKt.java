...
public final class LocalAtomics_commonKt {
    public static final int getValue(java.util.concurrent.atomic.AtomicInteger r0) {
            int r0 = r0.get()
            return r0
    }

    public static final void setValue(java.util.concurrent.atomic.AtomicInteger r0, int r1) {
            r0.set(r1)
            return
    }
}
