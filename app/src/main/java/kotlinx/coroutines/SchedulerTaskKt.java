...
public final class SchedulerTaskKt {
    public static final void afterTask(kotlinx.coroutines.scheduling.TaskContext r0) {
            r0.afterTask()
            return
    }

    public static final kotlinx.coroutines.scheduling.TaskContext getTaskContext(kotlinx.coroutines.scheduling.Task r0) {
            kotlinx.coroutines.scheduling.TaskContext r0 = r0.taskContext
            return r0
    }
