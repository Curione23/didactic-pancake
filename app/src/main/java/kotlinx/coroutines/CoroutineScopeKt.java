...
public final class CoroutineScopeKt {
    ...
    public static final void cancel(kotlinx.coroutines.CoroutineScope r0, java.lang.String r1, java.lang.Throwable r2) {
    ...
    public static final java.lang.Object currentCoroutineContext(kotlin.coroutines.Continuation<? super kotlin.coroutines.CoroutineContext> r0) {
    ...
    public static final boolean isActive(kotlinx.coroutines.CoroutineScope r1) {
    ...
    public static final kotlinx.coroutines.CoroutineScope plus(kotlinx.coroutines.CoroutineScope r1, kotlin.coroutines.CoroutineContext r2) {
            kotlinx.coroutines.internal.ContextScope r0 = new kotlinx.coroutines.internal.ContextScope
            kotlin.coroutines.CoroutineContext r1 = r1.getCoroutineContext()
            kotlin.coroutines.CoroutineContext r1 = r1.plus(r2)
            r0.<init>(r1)
