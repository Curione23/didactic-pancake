...
public final class FlowKt__ZipKt$combine$$inlined$unsafeFlow$3<R> implements kotlinx.coroutines.flow.Flow<R> {
    ...
    public java.lang.Object collect(kotlinx.coroutines.flow.FlowCollector<? super R> r6, kotlin.coroutines.Continuation<? super kotlin.Unit> r7) {
            r5 = this;
            kotlinx.coroutines.flow.Flow[] r0 = r5.$flowArray$inlined
            kotlin.jvm.internal.Intrinsics.needClassReification()
            kotlinx.coroutines.flow.FlowKt__ZipKt$combine$6$1 r1 = new kotlinx.coroutines.flow.FlowKt__ZipKt$combine$6$1
            kotlinx.coroutines.flow.Flow[] r2 = r5.$flowArray$inlined
            r1.<init>(r2)
            kotlin.jvm.functions.Function0 r1 = (kotlin.jvm.functions.Function0) r1
            kotlin.jvm.internal.Intrinsics.needClassReification()
            kotlinx.coroutines.flow.FlowKt__ZipKt$combine$6$2 r2 = new kotlinx.coroutines.flow.FlowKt__ZipKt$combine$6$2
