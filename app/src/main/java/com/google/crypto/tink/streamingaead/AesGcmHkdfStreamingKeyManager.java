...
public final class AesGcmHkdfStreamingKeyManager extends com.google.crypto.tink.internal.KeyTypeManager<com.google.crypto.tink.proto.AesGcmHkdfStreamingKey> {
    ...
    static /* synthetic */ com.google.crypto.tink.proto.AesGcmHkdfStreamingKeyFormat access$100(int r0, com.google.crypto.tink.proto.HashType r1, int r2, int r3) {
            com.google.crypto.tink.proto.AesGcmHkdfStreamingKeyFormat r0 = createKeyFormat(r0, r1, r2, r3)
            return r0
    }
    ...
    private static com.google.crypto.tink.proto.AesGcmHkdfStreamingKeyFormat createKeyFormat(int r1, com.google.crypto.tink.proto.HashType r2, int r3, int r4) {
    ...
    private static com.google.crypto.tink.KeyTemplate createKeyTemplate(int r0, com.google.crypto.tink.proto.HashType r1, int r2, int r3) {
            com.google.crypto.tink.proto.AesGcmHkdfStreamingKeyFormat r0 = createKeyFormat(r0, r1, r2, r3)
    ...
    private static void validateParams(com.google.crypto.tink.proto.AesGcmHkdfStreamingParams r2) throws java.security.GeneralSecurityException {
            ...
            int r2 = r2.getDerivedKeySize()
            int r2 = r2 + 25
            if (r0 < r2) goto L1c
            return
        L1c:
            java.security.GeneralSecurityException r2 = new java.security.GeneralSecurityException
            java.lang.String r0 = "ciphertext_segment_size must be at least (derived_key_size + NONCE_PREFIX_IN_BYTES + TAG_SIZE_IN_BYTES + 2)"
            r2.<init>(r0)
            throw r2
        L24:
            java.security.GeneralSecurityException r2 = new java.security.GeneralSecurityException
            java.lang.String r0 = "unknown HKDF hash type"
            r2.<init>(r0)
            throw r2
    }
    ...
    public com.google.crypto.tink.proto.AesGcmHkdfStreamingKey parseKey(com.google.crypto.tink.shaded.protobuf.ByteString r2) throws com.google.crypto.tink.shaded.protobuf.InvalidProtocolBufferException {
            ...
            com.google.crypto.tink.proto.AesGcmHkdfStreamingKey r2 = com.google.crypto.tink.proto.AesGcmHkdfStreamingKey.parseFrom(r2, r0)
            return r2
    }
    ...
    public void validateKey(com.google.crypto.tink.proto.AesGcmHkdfStreamingKey r3) throws java.security.GeneralSecurityException {
            ...
            com.google.crypto.tink.proto.AesGcmHkdfStreamingParams r3 = r3.getParams()
            validateParams(r3)
            return
    }
