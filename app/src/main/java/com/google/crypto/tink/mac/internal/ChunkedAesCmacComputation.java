...
final class ChunkedAesCmacComputation implements com.google.crypto.tink.mac.ChunkedMacComputation {
    ...
    ChunkedAesCmacComputation(com.google.crypto.tink.mac.AesCmacKey r4) throws java.security.GeneralSecurityException {
            r3 = this;
            r3.<init>()
            r0 = 0
            r3.finalized = r0
            ...
            com.google.crypto.tink.util.SecretBytes r4 = r4.getAesKey()
            com.google.crypto.tink.SecretKeyAccess r2 = com.google.crypto.tink.InsecureSecretKeyAccess.get()
            byte[] r4 = r4.toByteArray(r2)
    ...
    public byte[] computeMac() throws java.security.GeneralSecurityException {
        ...
        L1b:
            ...
            byte[] r0 = com.google.crypto.tink.mac.internal.AesUtil.cmacPad(r0)
            byte[] r1 = r4.subKey2
        ...
        L50:
            ...
            byte[] r3 = r3.array()
            byte[] r0 = com.google.crypto.tink.subtle.Bytes.xor(r0, r3)
            byte[] r0 = r2.doFinal(r0)
            com.google.crypto.tink.mac.AesCmacKey r2 = r4.key
            com.google.crypto.tink.mac.AesCmacParameters r2 = r2.getParameters()
    ...
    public void update(java.nio.ByteBuffer r6) throws java.security.GeneralSecurityException {
        ...
        L58:
            ...
            java.lang.String r0 = "Can not update after computing the MAC tag. Please create a new object."
            r6.<init>(r0)
            throw r6
    }
}
