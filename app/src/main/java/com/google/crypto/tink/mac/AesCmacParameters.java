...
public final class AesCmacParameters extends com.google.crypto.tink.mac.MacParameters {
    ...
    public static final class Builder {
        ...
        public com.google.crypto.tink.mac.AesCmacParameters.Builder setKeySizeBytes(int r3) throws java.security.GeneralSecurityException {
                r2 = this;
                r0 = 16
                if (r3 == r0) goto L1f
                r0 = 32
    ...
    public boolean equals(java.lang.Object r4) {
            r3 = this;
            boolean r0 = r4 instanceof com.google.crypto.tink.mac.AesCmacParameters
            r1 = 0
            if (r0 != 0) goto L6
            return r1
        L6:
            com.google.crypto.tink.mac.AesCmacParameters r4 = (com.google.crypto.tink.mac.AesCmacParameters) r4
            ...
            if (r0 != r2) goto L27
            com.google.crypto.tink.mac.AesCmacParameters$Variant r4 = r4.getVariant()
            com.google.crypto.tink.mac.AesCmacParameters$Variant r0 = r3.getVariant()
            if (r4 != r0) goto L27
            r1 = 1
        L27:
            return r1
