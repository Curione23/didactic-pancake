...
public final class AesCtrHmacAeadKeyManager extends com.google.crypto.tink.internal.KeyTypeManager<com.google.crypto.tink.proto.AesCtrHmacAeadKey> {
    ...
    static /* synthetic */ com.google.crypto.tink.internal.KeyTypeManager.KeyFactory.KeyFormat access$000(int r0, int r1, int r2, int r3, com.google.crypto.tink.proto.HashType r4, com.google.crypto.tink.KeyTemplate.OutputPrefixType r5) {
    ...
    private static com.google.crypto.tink.internal.KeyTypeManager.KeyFactory.KeyFormat<com.google.crypto.tink.proto.AesCtrHmacAeadKeyFormat> createKeyFormat(int r1, int r2, int r3, int r4, com.google.crypto.tink.proto.HashType r5, com.google.crypto.tink.KeyTemplate.OutputPrefixType r6) {
            ...
            com.google.crypto.tink.proto.AesCtrHmacAeadKeyFormat r1 = createKeyFormat(r1, r2, r3, r4, r5)
            r0.<init>(r1, r6)
            return r0
    }

    private static com.google.crypto.tink.proto.AesCtrHmacAeadKeyFormat createKeyFormat(int r2, int r3, int r4, int r5, com.google.crypto.tink.proto.HashType r6) {
    ...
    private static com.google.crypto.tink.KeyTemplate createKeyTemplate(int r0, int r1, int r2, int r3, com.google.crypto.tink.proto.HashType r4) {
            com.google.crypto.tink.proto.AesCtrHmacAeadKeyFormat r0 = createKeyFormat(r0, r1, r2, r3, r4)
    ...
    public com.google.crypto.tink.proto.AesCtrHmacAeadKey parseKey(com.google.crypto.tink.shaded.protobuf.ByteString r2) throws com.google.crypto.tink.shaded.protobuf.InvalidProtocolBufferException {
            ...
            com.google.crypto.tink.proto.AesCtrHmacAeadKey r2 = com.google.crypto.tink.proto.AesCtrHmacAeadKey.parseFrom(r2, r0)
            return r2
    }
    ...
    public void validateKey(com.google.crypto.tink.proto.AesCtrHmacAeadKey r3) throws java.security.GeneralSecurityException {
            ...
            r0.<init>()
            com.google.crypto.tink.proto.HmacKey r3 = r3.getHmacKey()
            r0.validateKey(r3)
            return
    }
