...
final class ManifestSchemaFactory implements com.google.crypto.tink.shaded.protobuf.SchemaFactory {
    ...
    private static class CompositeMessageInfoFactory implements com.google.crypto.tink.shaded.protobuf.MessageInfoFactory {
        ...
        public com.google.crypto.tink.shaded.protobuf.MessageInfo messageInfoFor(java.lang.Class<?> r6) {
            ...
            L4:
                ...
                if (r4 == 0) goto L13
                com.google.crypto.tink.shaded.protobuf.MessageInfo r6 = r3.messageInfoFor(r6)
                return r6
            L13:
                int r2 = r2 + 1
                goto L4
    ...
    private ManifestSchemaFactory(com.google.crypto.tink.shaded.protobuf.MessageInfoFactory r2) {
            ...
            com.google.crypto.tink.shaded.protobuf.MessageInfoFactory r2 = (com.google.crypto.tink.shaded.protobuf.MessageInfoFactory) r2
    ...
    private static com.google.crypto.tink.shaded.protobuf.MessageInfoFactory getDefaultMessageInfoFactory() {
            ...
            r2 = 0
            com.google.crypto.tink.shaded.protobuf.GeneratedMessageInfoFactory r3 = com.google.crypto.tink.shaded.protobuf.GeneratedMessageInfoFactory.getInstance()
            r1[r2] = r3
            r2 = 1
    ...
    private static com.google.crypto.tink.shaded.protobuf.MessageInfoFactory getDescriptorMessageInfoFactory() {
            ...
            java.lang.Object[] r1 = new java.lang.Object[r2]     // Catch: java.lang.Exception -> L19
            r2 = 0
            java.lang.Object r0 = r0.invoke(r2, r1)     // Catch: java.lang.Exception -> L19
            com.google.crypto.tink.shaded.protobuf.MessageInfoFactory r0 = (com.google.crypto.tink.shaded.protobuf.MessageInfoFactory) r0     // Catch: java.lang.Exception -> L19
            return r0
        L19:
            com.google.crypto.tink.shaded.protobuf.MessageInfoFactory r0 = com.google.crypto.tink.shaded.protobuf.ManifestSchemaFactory.EMPTY_FACTORY
            return r0
    }

    private static boolean isProto2(com.google.crypto.tink.shaded.protobuf.MessageInfo r1) {
            com.google.crypto.tink.shaded.protobuf.ProtoSyntax r1 = r1.getSyntax()
    ...
    private static <T> com.google.crypto.tink.shaded.protobuf.Schema<T> newSchema(java.lang.Class<T> r8, com.google.crypto.tink.shaded.protobuf.MessageInfo r9) {
        ...
        L41:
            boolean r0 = isProto2(r9)
            if (r0 == 0) goto L62
            com.google.crypto.tink.shaded.protobuf.NewInstanceSchema r3 = com.google.crypto.tink.shaded.protobuf.NewInstanceSchemas.full()
            com.google.crypto.tink.shaded.protobuf.ListFieldSchema r4 = com.google.crypto.tink.shaded.protobuf.ListFieldSchema.full()
            com.google.crypto.tink.shaded.protobuf.UnknownFieldSchema r5 = com.google.crypto.tink.shaded.protobuf.SchemaUtil.proto2UnknownFieldSetSchema()
            com.google.crypto.tink.shaded.protobuf.ExtensionSchema r6 = com.google.crypto.tink.shaded.protobuf.ExtensionSchemas.full()
            com.google.crypto.tink.shaded.protobuf.MapFieldSchema r7 = com.google.crypto.tink.shaded.protobuf.MapFieldSchemas.full()
            r1 = r8
            r2 = r9
            com.google.crypto.tink.shaded.protobuf.MessageSchema r8 = com.google.crypto.tink.shaded.protobuf.MessageSchema.newSchema(r1, r2, r3, r4, r5, r6, r7)
            goto L79
    ...
    public <T> com.google.crypto.tink.shaded.protobuf.Schema<T> createSchema(java.lang.Class<T> r3) {
            r2 = this;
            com.google.crypto.tink.shaded.protobuf.SchemaUtil.requireGeneratedMessage(r3)
            com.google.crypto.tink.shaded.protobuf.MessageInfoFactory r0 = r2.messageInfoFactory
            com.google.crypto.tink.shaded.protobuf.MessageInfo r0 = r0.messageInfoFor(r3)
            ...
            if (r3 == 0) goto L28
            com.google.crypto.tink.shaded.protobuf.UnknownFieldSchema r3 = com.google.crypto.tink.shaded.protobuf.SchemaUtil.unknownFieldSetLiteSchema()
            com.google.crypto.tink.shaded.protobuf.ExtensionSchema r1 = com.google.crypto.tink.shaded.protobuf.ExtensionSchemas.lite()
            com.google.crypto.tink.shaded.protobuf.MessageLite r0 = r0.getDefaultInstance()
            com.google.crypto.tink.shaded.protobuf.MessageSetSchema r3 = com.google.crypto.tink.shaded.protobuf.MessageSetSchema.newSchema(r3, r1, r0)
            return r3
        L28:
            com.google.crypto.tink.shaded.protobuf.UnknownFieldSchema r3 = com.google.crypto.tink.shaded.protobuf.SchemaUtil.proto2UnknownFieldSetSchema()
            com.google.crypto.tink.shaded.protobuf.ExtensionSchema r1 = com.google.crypto.tink.shaded.protobuf.ExtensionSchemas.full()
            com.google.crypto.tink.shaded.protobuf.MessageLite r0 = r0.getDefaultInstance()
            com.google.crypto.tink.shaded.protobuf.MessageSetSchema r3 = com.google.crypto.tink.shaded.protobuf.MessageSetSchema.newSchema(r3, r1, r0)
            return r3
        L39:
            com.google.crypto.tink.shaded.protobuf.Schema r3 = newSchema(r3, r0)
            return r3
    }
}
