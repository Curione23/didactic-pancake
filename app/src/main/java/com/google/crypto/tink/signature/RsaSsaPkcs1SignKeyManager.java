...
public final class RsaSsaPkcs1SignKeyManager extends com.google.crypto.tink.internal.PrivateKeyTypeManager<com.google.crypto.tink.proto.RsaSsaPkcs1PrivateKey, com.google.crypto.tink.proto.RsaSsaPkcs1PublicKey> {
    ...
    static /* synthetic */ com.google.crypto.tink.proto.RsaSsaPkcs1KeyFormat access$000(com.google.crypto.tink.proto.HashType r0, int r1, java.math.BigInteger r2) {
            com.google.crypto.tink.proto.RsaSsaPkcs1KeyFormat r0 = createKeyFormat(r0, r1, r2)
            return r0
    }

    private static com.google.crypto.tink.proto.RsaSsaPkcs1KeyFormat createKeyFormat(com.google.crypto.tink.proto.HashType r1, int r2, java.math.BigInteger r3) {
    ...
    private static com.google.crypto.tink.KeyTemplate createKeyTemplate(com.google.crypto.tink.proto.HashType r0, int r1, java.math.BigInteger r2, com.google.crypto.tink.KeyTemplate.OutputPrefixType r3) {
            com.google.crypto.tink.proto.RsaSsaPkcs1KeyFormat r0 = createKeyFormat(r0, r1, r2)
            ...
            com.google.crypto.tink.KeyTemplate r0 = com.google.crypto.tink.KeyTemplate.create(r1, r0, r3)
            return r0
    }
    ...
    public com.google.crypto.tink.proto.RsaSsaPkcs1PublicKey getPublicKey(com.google.crypto.tink.proto.RsaSsaPkcs1PrivateKey r1) throws java.security.GeneralSecurityException {
            r0 = this;
            com.google.crypto.tink.proto.RsaSsaPkcs1PublicKey r1 = r1.getPublicKey()
            return r1
    }
    ...
    public com.google.crypto.tink.proto.RsaSsaPkcs1PrivateKey parseKey(com.google.crypto.tink.shaded.protobuf.ByteString r2) throws com.google.crypto.tink.shaded.protobuf.InvalidProtocolBufferException {
            ...
            com.google.crypto.tink.proto.RsaSsaPkcs1PrivateKey r2 = com.google.crypto.tink.proto.RsaSsaPkcs1PrivateKey.parseFrom(r2, r0)
            return r2
    }
    ...
    public void validateKey(com.google.crypto.tink.proto.RsaSsaPkcs1PrivateKey r4) throws java.security.GeneralSecurityException {
            ...
            com.google.crypto.tink.proto.RsaSsaPkcs1PublicKey r4 = r4.getPublicKey()
            com.google.crypto.tink.proto.RsaSsaPkcs1Params r4 = r4.getParams()
            com.google.crypto.tink.signature.internal.SigUtil.validateRsaSsaPkcs1Params(r4)
            return
    }
