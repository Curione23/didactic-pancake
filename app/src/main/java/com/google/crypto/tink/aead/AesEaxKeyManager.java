...
public final class AesEaxKeyManager extends com.google.crypto.tink.internal.KeyTypeManager<com.google.crypto.tink.proto.AesEaxKey> {
    ...
    static /* synthetic */ com.google.crypto.tink.internal.KeyTypeManager.KeyFactory.KeyFormat access$000(int r0, int r1, com.google.crypto.tink.KeyTemplate.OutputPrefixType r2) {
    ...
    private static com.google.crypto.tink.internal.KeyTypeManager.KeyFactory.KeyFormat<com.google.crypto.tink.proto.AesEaxKeyFormat> createKeyFormat(int r1, int r2, com.google.crypto.tink.KeyTemplate.OutputPrefixType r3) {
    ...
    private static com.google.crypto.tink.KeyTemplate createKeyTemplate(int r1, int r2, com.google.crypto.tink.KeyTemplate.OutputPrefixType r3) {
            com.google.crypto.tink.proto.AesEaxKeyFormat$Builder r0 = com.google.crypto.tink.proto.AesEaxKeyFormat.newBuilder()
            com.google.crypto.tink.proto.AesEaxKeyFormat$Builder r1 = r0.setKeySize(r1)
            com.google.crypto.tink.proto.AesEaxParams$Builder r0 = com.google.crypto.tink.proto.AesEaxParams.newBuilder()
            com.google.crypto.tink.proto.AesEaxParams$Builder r2 = r0.setIvSize(r2)
    ...
    public com.google.crypto.tink.proto.AesEaxKey parseKey(com.google.crypto.tink.shaded.protobuf.ByteString r2) throws com.google.crypto.tink.shaded.protobuf.InvalidProtocolBufferException {
            ...
            com.google.crypto.tink.proto.AesEaxKey r2 = com.google.crypto.tink.proto.AesEaxKey.parseFrom(r2, r0)
            return r2
    }
    ...
    public void validateKey(com.google.crypto.tink.proto.AesEaxKey r3) throws java.security.GeneralSecurityException {
            ...
            r1 = 12
            if (r0 == r1) goto L37
            com.google.crypto.tink.proto.AesEaxParams r3 = r3.getParams()
            int r3 = r3.getIvSize()
            r0 = 16
            if (r3 != r0) goto L2f
            goto L37
