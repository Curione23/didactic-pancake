...
public final class ChaCha20Poly1305Key extends com.google.crypto.tink.aead.AeadKey {
    ...
    public static com.google.crypto.tink.aead.ChaCha20Poly1305Key create(com.google.crypto.tink.aead.ChaCha20Poly1305Parameters.Variant r2, com.google.crypto.tink.util.SecretBytes r3, @javax.annotation.Nullable java.lang.Integer r4) throws java.security.GeneralSecurityException {
        ...
        L31:
            ...
            r1 = 32
            if (r0 != r1) goto L47
            com.google.crypto.tink.aead.ChaCha20Poly1305Parameters r2 = com.google.crypto.tink.aead.ChaCha20Poly1305Parameters.create(r2)
            com.google.crypto.tink.aead.ChaCha20Poly1305Key r0 = new com.google.crypto.tink.aead.ChaCha20Poly1305Key
    ...
    public static com.google.crypto.tink.aead.ChaCha20Poly1305Key create(com.google.crypto.tink.util.SecretBytes r2) throws java.security.GeneralSecurityException {
            com.google.crypto.tink.aead.ChaCha20Poly1305Parameters$Variant r0 = com.google.crypto.tink.aead.ChaCha20Poly1305Parameters.Variant.NO_PREFIX
            r1 = 0
            com.google.crypto.tink.aead.ChaCha20Poly1305Key r2 = create(r0, r2, r1)
            return r2
    }
    ...
    private static com.google.crypto.tink.util.Bytes getOutputPrefix(com.google.crypto.tink.aead.ChaCha20Poly1305Parameters r4, @javax.annotation.Nullable java.lang.Integer r5) {
        ...
        L54:
            ...
            r0.<init>(r1)
            com.google.crypto.tink.aead.ChaCha20Poly1305Parameters$Variant r4 = r4.getVariant()
    ...
    public boolean equalsKey(com.google.crypto.tink.Key r4) {
            r3 = this;
            boolean r0 = r4 instanceof com.google.crypto.tink.aead.ChaCha20Poly1305Key
            r1 = 0
            if (r0 != 0) goto L6
            return r1
        L6:
            com.google.crypto.tink.aead.ChaCha20Poly1305Key r4 = (com.google.crypto.tink.aead.ChaCha20Poly1305Key) r4
            com.google.crypto.tink.aead.ChaCha20Poly1305Parameters r0 = r4.parameters
            com.google.crypto.tink.aead.ChaCha20Poly1305Parameters r2 = r3.parameters
