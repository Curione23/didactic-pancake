...
public final class AesCmacKeyManager extends com.google.crypto.tink.internal.KeyTypeManager<com.google.crypto.tink.proto.AesCmacKey> {
    ...
    public static void register(boolean r1) throws java.security.GeneralSecurityException {
            ...
            com.google.crypto.tink.internal.PrimitiveConstructor<com.google.crypto.tink.mac.AesCmacKey, com.google.crypto.tink.mac.ChunkedMac> r0 = com.google.crypto.tink.mac.AesCmacKeyManager.CHUNKED_MAC_PRIMITIVE_CONSTRUCTOR
    ...
    private static void validateSize(int r1) throws java.security.GeneralSecurityException {
            r0 = 32
            if (r1 != r0) goto L5
            return
        L5:
    ...
    public com.google.crypto.tink.proto.AesCmacKey parseKey(com.google.crypto.tink.shaded.protobuf.ByteString r2) throws com.google.crypto.tink.shaded.protobuf.InvalidProtocolBufferException {
            ...
            com.google.crypto.tink.proto.AesCmacKey r2 = com.google.crypto.tink.proto.AesCmacKey.parseFrom(r2, r0)
            return r2
    }
    ...
    public void validateKey(com.google.crypto.tink.proto.AesCmacKey r3) throws java.security.GeneralSecurityException {
            ...
            int r0 = r0.size()
            validateSize(r0)
            com.google.crypto.tink.proto.AesCmacParams r3 = r3.getParams()
            validateParams(r3)
            return
    }
