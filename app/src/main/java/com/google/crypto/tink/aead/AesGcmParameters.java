...
public final class AesGcmParameters extends com.google.crypto.tink.aead.AeadParameters {
    ...
    public static final class Builder {
        ...
        public com.google.crypto.tink.aead.AesGcmParameters build() throws java.security.GeneralSecurityException {
                ...
                if (r0 == 0) goto L2c
                com.google.crypto.tink.aead.AesGcmParameters r0 = new com.google.crypto.tink.aead.AesGcmParameters
                java.lang.Integer r1 = r7.keySizeBytes
                int r2 = r1.intValue()
                java.lang.Integer r1 = r7.ivSizeBytes
                int r3 = r1.intValue()
                java.lang.Integer r1 = r7.tagSizeBytes
                int r4 = r1.intValue()
        ...
        public com.google.crypto.tink.aead.AesGcmParameters.Builder setIvSizeBytes(int r3) throws java.security.GeneralSecurityException {
                r2 = this;
                if (r3 <= 0) goto L9
            ...
            L9:
                ...
                java.lang.String r1 = "Invalid IV size in bytes %d; IV size must be positive"
                java.lang.String r3 = java.lang.String.format(r1, r3)
                r0.<init>(r3)
                throw r0
        }

        public com.google.crypto.tink.aead.AesGcmParameters.Builder setKeySizeBytes(int r3) throws java.security.GeneralSecurityException {
                r2 = this;
                r0 = 16
                if (r3 == r0) goto L21
                r0 = 24
            ...
            Ld:
                ...
                java.lang.Integer r3 = java.lang.Integer.valueOf(r3)
                java.lang.Object[] r3 = new java.lang.Object[]{r3}
                java.lang.String r1 = "Invalid key size %d; only 16-byte, 24-byte and 32-byte AES keys are supported"
                java.lang.String r3 = java.lang.String.format(r1, r3)
                r0.<init>(r3)
                throw r0
            L21:
        ...
        public com.google.crypto.tink.aead.AesGcmParameters.Builder setTagSizeBytes(int r3) throws java.security.GeneralSecurityException {
                r2 = this;
                r0 = 12
                if (r3 == r0) goto L29
                r0 = 13
            ...
            L15:
                ...
                java.lang.Integer r3 = java.lang.Integer.valueOf(r3)
                java.lang.Object[] r3 = new java.lang.Object[]{r3}
                java.lang.String r1 = "Invalid tag size in bytes %d; value must be one of the following: 12, 13, 14, 15 or 16 bytes"
                java.lang.String r3 = java.lang.String.format(r1, r3)
                r0.<init>(r3)
                throw r0
            L29:
    ...
    public boolean equals(java.lang.Object r4) {
            r3 = this;
            boolean r0 = r4 instanceof com.google.crypto.tink.aead.AesGcmParameters
            r1 = 0
            if (r0 != 0) goto L6
            return r1
        L6:
            com.google.crypto.tink.aead.AesGcmParameters r4 = (com.google.crypto.tink.aead.AesGcmParameters) r4
            int r0 = r4.getKeySizeBytes()
            int r2 = r3.getKeySizeBytes()
            if (r0 != r2) goto L31
            int r0 = r4.getIvSizeBytes()
            int r2 = r3.getIvSizeBytes()
            if (r0 != r2) goto L31
            int r0 = r4.getTagSizeBytes()
            int r2 = r3.getTagSizeBytes()
            if (r0 != r2) goto L31
            com.google.crypto.tink.aead.AesGcmParameters$Variant r4 = r4.getVariant()
            com.google.crypto.tink.aead.AesGcmParameters$Variant r0 = r3.getVariant()
            if (r4 != r0) goto L31
            r1 = 1
        L31:
            return r1
