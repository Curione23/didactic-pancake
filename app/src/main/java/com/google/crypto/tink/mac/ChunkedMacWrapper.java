...
public class ChunkedMacWrapper implements com.google.crypto.tink.PrimitiveWrapper<com.google.crypto.tink.mac.ChunkedMac, com.google.crypto.tink.mac.ChunkedMac> {
    ...
    private static class WrappedChunkedMac implements com.google.crypto.tink.mac.ChunkedMac {
        ...
        private com.google.crypto.tink.mac.ChunkedMac getChunkedMac(com.google.crypto.tink.PrimitiveSet.Entry<com.google.crypto.tink.mac.ChunkedMac> r1) {
                r0 = this;
                java.lang.Object r1 = r1.getFullPrimitive()
                com.google.crypto.tink.mac.ChunkedMac r1 = (com.google.crypto.tink.mac.ChunkedMac) r1
                return r1
        }
        ...
        public com.google.crypto.tink.mac.ChunkedMacVerification createVerification(byte[] r4) throws java.security.GeneralSecurityException {
                ...
                r1.<init>()
                com.google.crypto.tink.PrimitiveSet<com.google.crypto.tink.mac.ChunkedMac> r2 = r3.primitives
            ...
            L14:
                ...
                com.google.crypto.tink.mac.ChunkedMac r2 = r3.getChunkedMac(r2)
                com.google.crypto.tink.mac.ChunkedMacVerification r2 = r2.createVerification(r4)
                r1.add(r2)
                goto L14
            L2c:
                com.google.crypto.tink.PrimitiveSet<com.google.crypto.tink.mac.ChunkedMac> r0 = r3.primitives
            ...
            L36:
                ...
                goto L36
            L4e:
                com.google.crypto.tink.mac.ChunkedMacWrapper$WrappedChunkedMacVerification r4 = new com.google.crypto.tink.mac.ChunkedMacWrapper$WrappedChunkedMacVerification
                r0 = 0
                r4.<init>(r1, r0)
                return r4
        }
    ...
    @Override // com.google.crypto.tink.PrimitiveWrapper
    public com.google.crypto.tink.mac.ChunkedMac wrap(com.google.crypto.tink.PrimitiveSet<com.google.crypto.tink.mac.ChunkedMac> r4) throws java.security.GeneralSecurityException {
            r3 = this;
            if (r4 == 0) goto L42
            com.google.crypto.tink.PrimitiveSet$Entry r0 = r4.getPrimary()
            if (r0 == 0) goto L3a
            java.util.Collection r0 = r4.getAll()
            java.util.Iterator r0 = r0.iterator()
        L10:
        ...
        L20:
            ...
            java.lang.Object r2 = r1.next()
            com.google.crypto.tink.PrimitiveSet$Entry r2 = (com.google.crypto.tink.PrimitiveSet.Entry) r2
            java.lang.Object r2 = r2.getFullPrimitive()
            com.google.crypto.tink.mac.ChunkedMac r2 = (com.google.crypto.tink.mac.ChunkedMac) r2
            goto L20
        L33:
        ...
        L42:
            java.security.GeneralSecurityException r4 = new java.security.GeneralSecurityException
            java.lang.String r0 = "primitive set must be non-null"
            r4.<init>(r0)
            throw r4
    }
