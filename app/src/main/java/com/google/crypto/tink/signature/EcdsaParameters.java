...
public final class EcdsaParameters extends com.google.crypto.tink.signature.SignatureParameters {
    ...
    public static final class Builder {
        ...
        public com.google.crypto.tink.signature.EcdsaParameters build() throws java.security.GeneralSecurityException {
                ...
                if (r0 == 0) goto L73
                com.google.crypto.tink.signature.EcdsaParameters$HashType r1 = r8.hashType
                if (r1 == 0) goto L6b
                com.google.crypto.tink.signature.EcdsaParameters$Variant r1 = r8.variant
                if (r1 == 0) goto L63
            ...
            L4b:
                ...
                throw r0
            L53:
                com.google.crypto.tink.signature.EcdsaParameters r0 = new com.google.crypto.tink.signature.EcdsaParameters
    ...
    public static final class CurveType {
        ...
        public static com.google.crypto.tink.signature.EcdsaParameters.CurveType fromParameterSpec(java.security.spec.ECParameterSpec r2) throws java.security.GeneralSecurityException {
                ...
                java.security.spec.ECParameterSpec r1 = r0.toParameterSpec()
                boolean r1 = com.google.crypto.tink.internal.EllipticCurvesUtil.isSameEcParameterSpec(r2, r1)
                if (r1 == 0) goto Ld
                return r0
            Ld:
            ...
            L1a:
                ...
                java.security.spec.ECParameterSpec r1 = r0.toParameterSpec()
                boolean r2 = com.google.crypto.tink.internal.EllipticCurvesUtil.isSameEcParameterSpec(r2, r1)
                if (r2 == 0) goto L27
                return r0
            L27:
                java.security.GeneralSecurityException r2 = new java.security.GeneralSecurityException
                java.lang.String r0 = "unknown ECParameterSpec"
                r2.<init>(r0)
                throw r2
        }
    ...
    public boolean equals(java.lang.Object r4) {
            r3 = this;
            boolean r0 = r4 instanceof com.google.crypto.tink.signature.EcdsaParameters
            r1 = 0
            if (r0 != 0) goto L6
            return r1
        L6:
            com.google.crypto.tink.signature.EcdsaParameters r4 = (com.google.crypto.tink.signature.EcdsaParameters) r4
            com.google.crypto.tink.signature.EcdsaParameters$SignatureEncoding r0 = r4.getSignatureEncoding()
            com.google.crypto.tink.signature.EcdsaParameters$SignatureEncoding r2 = r3.getSignatureEncoding()
            if (r0 != r2) goto L31
            com.google.crypto.tink.signature.EcdsaParameters$CurveType r0 = r4.getCurveType()
            com.google.crypto.tink.signature.EcdsaParameters$CurveType r2 = r3.getCurveType()
            if (r0 != r2) goto L31
            com.google.crypto.tink.signature.EcdsaParameters$HashType r0 = r4.getHashType()
            com.google.crypto.tink.signature.EcdsaParameters$HashType r2 = r3.getHashType()
            if (r0 != r2) goto L31
            com.google.crypto.tink.signature.EcdsaParameters$Variant r4 = r4.getVariant()
            com.google.crypto.tink.signature.EcdsaParameters$Variant r0 = r3.getVariant()
            if (r4 != r0) goto L31
            r1 = 1
        L31:
            return r1
