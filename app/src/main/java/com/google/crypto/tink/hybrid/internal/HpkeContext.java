...
final class HpkeContext {
    ...
    private HpkeContext(byte[] r1, byte[] r2, byte[] r3, java.math.BigInteger r4, com.google.crypto.tink.hybrid.internal.HpkeAead r5) {
            r0 = this;
            r0.<init>()
            r0.encapsulatedKey = r1
            r0.key = r2
            r0.baseNonce = r3
            java.math.BigInteger r1 = java.math.BigInteger.ZERO
            r0.sequenceNumber = r1
            r0.maxSequenceNumber = r4
            r0.aead = r5
            return
    }
    ...
    static com.google.crypto.tink.hybrid.internal.HpkeContext createContext(byte[] r16, byte[] r17, com.google.crypto.tink.hybrid.internal.HpkeKem r18, com.google.crypto.tink.hybrid.internal.HpkeKdf r19, com.google.crypto.tink.hybrid.internal.HpkeAead r20, byte[] r21) throws java.security.GeneralSecurityException {
            r6 = r19
            byte[] r0 = r18.getKemId()
            byte[] r1 = r19.getKdfId()
            byte[] r2 = r20.getAeadId()
            byte[] r7 = com.google.crypto.tink.hybrid.internal.HpkeUtil.hpkeSuiteId(r0, r1, r2)
            byte[] r0 = com.google.crypto.tink.hybrid.internal.HpkeUtil.EMPTY_SALT
            byte[] r1 = com.google.crypto.tink.hybrid.internal.HpkeContext.EMPTY_IKM
            java.lang.String r2 = "psk_id_hash"
            byte[] r0 = r6.labeledExtract(r0, r1, r2, r7)
            byte[] r2 = com.google.crypto.tink.hybrid.internal.HpkeUtil.EMPTY_SALT
            java.lang.String r3 = "info_hash"
            r4 = r21
            byte[] r2 = r6.labeledExtract(r2, r4, r3, r7)
            byte[] r3 = com.google.crypto.tink.hybrid.internal.HpkeUtil.BASE_MODE
            byte[][] r0 = new byte[][]{r3, r0, r2}
            byte[] r8 = com.google.crypto.tink.subtle.Bytes.concat(r0)
            java.lang.String r0 = "secret"
            r2 = r17
            byte[] r9 = r6.labeledExtract(r2, r1, r0, r7)
            ...
            com.google.crypto.tink.hybrid.internal.HpkeContext r0 = new com.google.crypto.tink.hybrid.internal.HpkeContext
            r10 = r0
            r11 = r16
            r15 = r20
    ...
    static com.google.crypto.tink.hybrid.internal.HpkeContext createSenderContext(com.google.crypto.tink.proto.HpkePublicKey r6, com.google.crypto.tink.hybrid.internal.HpkeKem r7, com.google.crypto.tink.hybrid.internal.HpkeKdf r8, com.google.crypto.tink.hybrid.internal.HpkeAead r9, byte[] r10) throws java.security.GeneralSecurityException {
            com.google.crypto.tink.shaded.protobuf.ByteString r6 = r6.getPublicKey()
            byte[] r6 = r6.toByteArray()
            com.google.crypto.tink.hybrid.internal.HpkeKemEncapOutput r6 = r7.encapsulate(r6)
            byte[] r0 = r6.getEncapsulatedKey()
            byte[] r1 = r6.getSharedSecret()
            r2 = r7
            r3 = r8
            r4 = r9
            r5 = r10
    ...
    private static java.math.BigInteger maxSequenceNumber(int r1) {
            java.math.BigInteger r0 = java.math.BigInteger.ONE
            int r1 = r1 * 8
            java.math.BigInteger r1 = r0.shiftLeft(r1)
            java.math.BigInteger r0 = java.math.BigInteger.ONE
