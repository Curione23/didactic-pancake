...
public final class HmacKey extends com.google.crypto.tink.mac.MacKey {
    ...
    public static class Builder {
        ...
        public com.google.crypto.tink.mac.HmacKey build() throws java.security.GeneralSecurityException {
            ...
            L3e:
                ...
                com.google.crypto.tink.mac.HmacKey r0 = new com.google.crypto.tink.mac.HmacKey
    ...
    public boolean equalsKey(com.google.crypto.tink.Key r4) {
            r3 = this;
            boolean r0 = r4 instanceof com.google.crypto.tink.mac.HmacKey
            r1 = 0
            if (r0 != 0) goto L6
            return r1
        L6:
            com.google.crypto.tink.mac.HmacKey r4 = (com.google.crypto.tink.mac.HmacKey) r4
            com.google.crypto.tink.mac.HmacParameters r0 = r4.parameters
            com.google.crypto.tink.mac.HmacParameters r2 = r3.parameters
