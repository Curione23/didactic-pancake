...
public final class RsaSsaPssSignKeyManager extends com.google.crypto.tink.internal.PrivateKeyTypeManager<com.google.crypto.tink.proto.RsaSsaPssPrivateKey, com.google.crypto.tink.proto.RsaSsaPssPublicKey> {
    ...
    static /* synthetic */ com.google.crypto.tink.proto.RsaSsaPssKeyFormat access$000(com.google.crypto.tink.proto.HashType r0, com.google.crypto.tink.proto.HashType r1, int r2, int r3, java.math.BigInteger r4) {
            com.google.crypto.tink.proto.RsaSsaPssKeyFormat r0 = createKeyFormat(r0, r1, r2, r3, r4)
            return r0
    }

    private static com.google.crypto.tink.proto.RsaSsaPssKeyFormat createKeyFormat(com.google.crypto.tink.proto.HashType r1, com.google.crypto.tink.proto.HashType r2, int r3, int r4, java.math.BigInteger r5) {
    ...
    private static com.google.crypto.tink.KeyTemplate createKeyTemplate(com.google.crypto.tink.proto.HashType r0, com.google.crypto.tink.proto.HashType r1, int r2, int r3, java.math.BigInteger r4, com.google.crypto.tink.KeyTemplate.OutputPrefixType r5) {
            com.google.crypto.tink.proto.RsaSsaPssKeyFormat r0 = createKeyFormat(r0, r1, r2, r3, r4)
            ...
            com.google.crypto.tink.KeyTemplate r0 = com.google.crypto.tink.KeyTemplate.create(r1, r0, r5)
            return r0
    }
    ...
    public com.google.crypto.tink.proto.RsaSsaPssPublicKey getPublicKey(com.google.crypto.tink.proto.RsaSsaPssPrivateKey r1) throws java.security.GeneralSecurityException {
            r0 = this;
            com.google.crypto.tink.proto.RsaSsaPssPublicKey r1 = r1.getPublicKey()
            return r1
    }
    ...
    public com.google.crypto.tink.proto.RsaSsaPssPrivateKey parseKey(com.google.crypto.tink.shaded.protobuf.ByteString r2) throws com.google.crypto.tink.shaded.protobuf.InvalidProtocolBufferException {
            ...
            com.google.crypto.tink.proto.RsaSsaPssPrivateKey r2 = com.google.crypto.tink.proto.RsaSsaPssPrivateKey.parseFrom(r2, r0)
            return r2
    }
    ...
    public void validateKey(com.google.crypto.tink.proto.RsaSsaPssPrivateKey r4) throws java.security.GeneralSecurityException {
            ...
            com.google.crypto.tink.proto.RsaSsaPssPublicKey r4 = r4.getPublicKey()
            com.google.crypto.tink.proto.RsaSsaPssParams r4 = r4.getParams()
            com.google.crypto.tink.signature.internal.SigUtil.validateRsaSsaPssParams(r4)
            return
    }
