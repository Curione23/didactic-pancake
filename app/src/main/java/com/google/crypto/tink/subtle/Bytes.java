...
public final class Bytes {
    ...
    public static int byteArrayToInt(byte[] r1) {
            int r0 = r1.length
            int r1 = byteArrayToInt(r1, r0)
            return r1
    }

    public static int byteArrayToInt(byte[] r1, int r2) {
            r0 = 0
            int r1 = byteArrayToInt(r1, r0, r2)
            return r1
    }
    ...
    public static byte[] concat(byte[]... r7) throws java.security.GeneralSecurityException {
            int r0 = r7.length
            r1 = 0
            r2 = r1
            r3 = r2
    ...
    public static final boolean equal(byte[] r0, byte[] r1) {
    ...
    public static final byte[] xorEnd(byte[] r5, byte[] r6) {
        ...
        L1e:
            ...
            java.lang.String r6 = "xorEnd requires a.length >= b.length"
            r5.<init>(r6)
            throw r5
    }
}
