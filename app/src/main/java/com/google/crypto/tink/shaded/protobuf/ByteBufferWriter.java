...
final class ByteBufferWriter {
    ...
    private static long getChannelFieldOffset(java.lang.Class<?> r2) {
            ...
            java.lang.reflect.Field r2 = r2.getDeclaredField(r0)     // Catch: java.lang.Throwable -> L13
            long r0 = com.google.crypto.tink.shaded.protobuf.UnsafeUtil.objectFieldOffset(r2)     // Catch: java.lang.Throwable -> L13
            return r0
        L13:
            r0 = -1
            return r0
    ...
    static void write(java.nio.ByteBuffer r4, java.io.OutputStream r5) throws java.io.IOException {
            int r0 = r4.position()
            boolean r1 = r4.hasArray()     // Catch: java.lang.Throwable -> L48
            if (r1 == 0) goto L1f
            byte[] r1 = r4.array()     // Catch: java.lang.Throwable -> L48
            int r2 = r4.arrayOffset()     // Catch: java.lang.Throwable -> L48
            int r3 = r4.position()     // Catch: java.lang.Throwable -> L48
            int r2 = r2 + r3
            int r3 = r4.remaining()     // Catch: java.lang.Throwable -> L48
            r5.write(r1, r2, r3)     // Catch: java.lang.Throwable -> L48
            goto L44
        L1f:
            boolean r1 = writeToChannel(r4, r5)     // Catch: java.lang.Throwable -> L48
            if (r1 != 0) goto L44
            int r1 = r4.remaining()     // Catch: java.lang.Throwable -> L48
            byte[] r1 = getOrCreateBuffer(r1)     // Catch: java.lang.Throwable -> L48
        L2d:
            boolean r2 = r4.hasRemaining()     // Catch: java.lang.Throwable -> L48
            if (r2 == 0) goto L44
            int r2 = r4.remaining()     // Catch: java.lang.Throwable -> L48
            int r3 = r1.length     // Catch: java.lang.Throwable -> L48
            int r2 = java.lang.Math.min(r2, r3)     // Catch: java.lang.Throwable -> L48
            r3 = 0
            r4.get(r1, r3, r2)     // Catch: java.lang.Throwable -> L48
            r5.write(r1, r3, r2)     // Catch: java.lang.Throwable -> L48
            goto L2d
        L44:
            r4.position(r0)
            return
    ...
    private static boolean writeToChannel(java.nio.ByteBuffer r4, java.io.OutputStream r5) throws java.io.IOException {
            ...
            if (r2 < 0) goto L1f
            java.lang.Class<?> r2 = com.google.crypto.tink.shaded.protobuf.ByteBufferWriter.FILE_OUTPUT_STREAM_CLASS
            boolean r2 = r2.isInstance(r5)
            if (r2 == 0) goto L1f
            java.lang.Object r5 = com.google.crypto.tink.shaded.protobuf.UnsafeUtil.getObject(r5, r0)     // Catch: java.lang.ClassCastException -> L17
            java.nio.channels.WritableByteChannel r5 = (java.nio.channels.WritableByteChannel) r5     // Catch: java.lang.ClassCastException -> L17
            goto L18
        L17:
            r5 = 0
        L18:
