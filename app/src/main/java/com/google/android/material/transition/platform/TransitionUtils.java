...
class TransitionUtils {
    ...
    static com.google.android.material.shape.ShapeAppearanceModel convertToRelativeCornerSizes(com.google.android.material.shape.ShapeAppearanceModel r1, android.graphics.RectF r2) {
            com.google.android.material.transition.platform.TransitionUtils$$ExternalSyntheticLambda0 r0 = new com.google.android.material.transition.platform.TransitionUtils$$ExternalSyntheticLambda0
            r0.<init>(r2)
    ...
    static boolean maybeApplyThemeDuration(android.transition.Transition r4, android.content.Context r5, int r6) {
            if (r6 == 0) goto L19
    ...
    static boolean maybeApplyThemeInterpolator(android.transition.Transition r1, android.content.Context r2, int r3, android.animation.TimeInterpolator r4) {
            if (r3 == 0) goto L11
    ...
    static boolean maybeApplyThemePath(android.transition.Transition r0, android.content.Context r1, int r2) {
            if (r2 == 0) goto Ld
    ...
    static android.transition.PathMotion resolveThemePath(android.content.Context r3, int r4) {
