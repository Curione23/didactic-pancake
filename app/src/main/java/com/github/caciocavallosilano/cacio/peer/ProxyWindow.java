...
/* JADX WARN: Classes with same name are omitted, all sources:
  DroidBridge.Launcher-v0.3.9.apk:assets/components/caciocavallo.zip:caciocavallo17/cacio-shared-1.19.1-SNAPSHOT.jar:com/github/caciocavallosilano/cacio/peer/ProxyWindow.class
  DroidBridge.Launcher-v0.3.9.apk:assets/components/caciocavallo17/cacio-shared-1.19.1-SNAPSHOT.jar:com/github/caciocavallosilano/cacio/peer/ProxyWindow.class
 */
/* JADX INFO: loaded from: DroidBridge.Launcher-v0.3.9.apk:assets/components/caciocavallo.zip:caciocavallo17/cacio-shared-1.19.1-SNAPSHOT.jar:com/github/caciocavallosilano/cacio/peer/ProxyWindow.class */
public class ProxyWindow extends java.awt.Window {
    private com.github.caciocavallosilano.cacio.peer.CacioComponentPeer target;
    private static java.lang.reflect.Field dispatcherField;
    private static java.lang.reflect.Method dispatchMethod;

    ProxyWindow(com.github.caciocavallosilano.cacio.peer.CacioComponentPeer r4, javax.swing.JComponent r5) {
            r3 = this;
            r0 = r3
            r1 = 0
            r0.<init>(r1)
    ...
    com.github.caciocavallosilano.cacio.peer.CacioComponentPeer getTargetPeer() {
            r2 = this;
            r0 = r2
            com.github.caciocavallosilano.cacio.peer.CacioComponentPeer r0 = r0.target
            return r0
    }
    ...
    private static void initReflection() {
            ...
            com.github.caciocavallosilano.cacio.peer.ProxyWindow.dispatcherField = r0     // Catch: java.lang.Exception -> L33
            java.lang.reflect.Field r0 = com.github.caciocavallosilano.cacio.peer.ProxyWindow.dispatcherField     // Catch: java.lang.Exception -> L33
            r1 = 1
            ...
            com.github.caciocavallosilano.cacio.peer.ProxyWindow.dispatchMethod = r0     // Catch: java.lang.Exception -> L33
            java.lang.reflect.Method r0 = com.github.caciocavallosilano.cacio.peer.ProxyWindow.dispatchMethod     // Catch: java.lang.Exception -> L33
            r1 = 1
            r0.setAccessible(r1)     // Catch: java.lang.Exception -> L33
            goto L44
        L33:
    ...
    private void doLightweightDispatching(java.awt.AWTEvent r8) {
            r7 = this;
            java.lang.reflect.Field r0 = com.github.caciocavallosilano.cacio.peer.ProxyWindow.dispatcherField
            if (r0 != 0) goto L9
            initReflection()
        L9:
            java.lang.reflect.Field r0 = com.github.caciocavallosilano.cacio.peer.ProxyWindow.dispatcherField     // Catch: java.lang.Exception -> L28
            r1 = r7
            java.lang.Object r0 = r0.get(r1)     // Catch: java.lang.Exception -> L28
            r9 = r0
            r0 = r9
            if (r0 == 0) goto L25
            java.lang.reflect.Method r0 = com.github.caciocavallosilano.cacio.peer.ProxyWindow.dispatchMethod     // Catch: java.lang.Exception -> L28
            r1 = r9
            r2 = 1
