...
/* JADX WARN: Classes with same name are omitted, all sources:
  DroidBridge.Launcher-v0.3.9.apk:assets/components/lwjgl3.3.3/lwjgl-glfw-classes.jar:org/lwjgl/util/vma/VmaCheckDefragmentationBreakFunctionI.class
  DroidBridge.Launcher-v0.3.9.apk:assets/components/lwjgl3.4.1/lwjgl-glfw-classes.jar:org/lwjgl/util/vma/VmaCheckDefragmentationBreakFunctionI.class
 */
/* JADX INFO: loaded from: DroidBridge.Launcher-v0.3.9.apk:assets/components/lwjgl3.3.3/lwjgl-glfw-classes.jar:org/lwjgl/util/vma/VmaCheckDefragmentationBreakFunctionI.class */
@java.lang.FunctionalInterface
@org.lwjgl.system.NativeType("PFN_vmaCheckDefragmentationBreakFunction")
public interface VmaCheckDefragmentationBreakFunctionI extends org.lwjgl.system.CallbackI {
    ...
    default org.lwjgl.system.libffi.FFICIF getCallInterface() {
            r2 = this;
            org.lwjgl.system.libffi.FFICIF r0 = org.lwjgl.util.vma.VmaCheckDefragmentationBreakFunctionI.CIF
            return r0
    }
    ...
    static {
            ...
            org.lwjgl.util.vma.VmaCheckDefragmentationBreakFunctionI.CIF = r0
            return
    }
}
