...
/* JADX INFO: loaded from: DroidBridge.Launcher-v0.3.9.apk:assets/components/lwjgl3.4.1/lwjgl-glfw-classes.jar:org/lwjgl/util/shaderc/SPVParsedInstructionFnI.class */
@java.lang.FunctionalInterface
@org.lwjgl.system.NativeType("spv_parsed_instruction_fn_t")
public interface SPVParsedInstructionFnI extends org.lwjgl.system.CallbackI {
    ...
    default org.lwjgl.system.Callback.Descriptor getDescriptor() {
            r2 = this;
            org.lwjgl.system.Callback$Descriptor r0 = org.lwjgl.util.shaderc.SPVParsedInstructionFnI.DESCRIPTOR
            return r0
    }
    ...
    default void callback(long r9, long r11) {
            ...
            long r1 = org.lwjgl.system.MemoryUtil.memGetAddress(r1)
            r2 = r11
            int r3 = org.lwjgl.util.shaderc.SPVParsedInstructionFnI.POINTER_SIZE
            long r3 = (long) r3
            long r2 = r2 + r3
    ...
    int invoke(@org.lwjgl.system.NativeType("void *") long r1, @org.lwjgl.system.NativeType("spv_parsed_instruction_t const *") long r3);
    ...
    static {
            ...
            r1.<init>(r2, r3)
            org.lwjgl.util.shaderc.SPVParsedInstructionFnI.DESCRIPTOR = r0
            return
    }
}
