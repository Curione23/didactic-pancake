...
/* JADX INFO: loaded from: DroidBridge.Launcher-v0.3.9.apk:assets/components/lwjgl3.4.1/lwjgl-glfw-classes.jar:org/lwjgl/util/shaderc/ShadercIncludeResultReleaseI.class */
@java.lang.FunctionalInterface
@org.lwjgl.system.NativeType("shaderc_include_result_release_fn")
public interface ShadercIncludeResultReleaseI extends org.lwjgl.system.CallbackI {
    ...
    default org.lwjgl.system.Callback.Descriptor getDescriptor() {
            r2 = this;
            org.lwjgl.system.Callback$Descriptor r0 = org.lwjgl.util.shaderc.ShadercIncludeResultReleaseI.DESCRIPTOR
            return r0
    }
    ...
    default void callback(long r9, long r11) {
            ...
            long r1 = org.lwjgl.system.MemoryUtil.memGetAddress(r1)
            r2 = r11
            int r3 = org.lwjgl.util.shaderc.ShadercIncludeResultReleaseI.POINTER_SIZE
            long r3 = (long) r3
            long r2 = r2 + r3
    ...
    void invoke(@org.lwjgl.system.NativeType("void *") long r1, @org.lwjgl.system.NativeType("shaderc_include_result *") long r3);
    ...
    static {
            ...
            r1.<init>(r2, r3)
            org.lwjgl.util.shaderc.ShadercIncludeResultReleaseI.DESCRIPTOR = r0
            return
    }
}
