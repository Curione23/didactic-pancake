...
/* JADX WARN: Classes with same name are omitted, all sources:
  DroidBridge.Launcher-v0.3.9.apk:assets/components/lwjgl3.3.3/lwjgl-glfw-classes.jar:org/lwjgl/vulkan/VkQueue.class
  DroidBridge.Launcher-v0.3.9.apk:assets/components/lwjgl3.4.1/lwjgl-glfw-classes.jar:org/lwjgl/vulkan/VkQueue.class
 */
/* JADX INFO: loaded from: DroidBridge.Launcher-v0.3.9.apk:assets/components/lwjgl3.3.3/lwjgl-glfw-classes.jar:org/lwjgl/vulkan/VkQueue.class */
public class VkQueue extends org.lwjgl.vulkan.DispatchableHandleDevice {
    private final org.lwjgl.vulkan.VkDevice device;

    public VkQueue(long r6, org.lwjgl.vulkan.VkDevice r8) {
            r5 = this;
            r0 = r5
            r1 = r6
            r2 = r8
