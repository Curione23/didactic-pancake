...
/* JADX WARN: Classes with same name are omitted, all sources:
  DroidBridge.Launcher-v0.3.9.apk:assets/components/lwjgl3.3.3/lwjgl-glfw-classes.jar:org/lwjgl/vulkan/video/STDVulkanVideoCodecH265.class
  DroidBridge.Launcher-v0.3.9.apk:assets/components/lwjgl3.4.1/lwjgl-glfw-classes.jar:org/lwjgl/vulkan/video/STDVulkanVideoCodecH265.class
 */
/* JADX INFO: loaded from: DroidBridge.Launcher-v0.3.9.apk:assets/components/lwjgl3.3.3/lwjgl-glfw-classes.jar:org/lwjgl/vulkan/video/STDVulkanVideoCodecH265.class */
public final class STDVulkanVideoCodecH265 {
    ...
    public static final int STD_VIDEO_H265_NO_REFERENCE_PICTURE = 255;
    ...
    public static final int STD_VIDEO_H265_CHROMA_FORMAT_IDC_INVALID = Integer.MAX_VALUE;
    ...
    public static final int STD_VIDEO_H265_PROFILE_IDC_INVALID = Integer.MAX_VALUE;
    public static final int STD_VIDEO_H264_LEVEL_IDC_1_0 = 0;
    public static final int STD_VIDEO_H264_LEVEL_IDC_2_0 = 1;
    public static final int STD_VIDEO_H264_LEVEL_IDC_2_1 = 2;
    public static final int STD_VIDEO_H264_LEVEL_IDC_3_0 = 3;
    public static final int STD_VIDEO_H264_LEVEL_IDC_3_1 = 4;
    public static final int STD_VIDEO_H264_LEVEL_IDC_4_0 = 5;
    public static final int STD_VIDEO_H264_LEVEL_IDC_4_1 = 6;
    public static final int STD_VIDEO_H264_LEVEL_IDC_5_0 = 7;
    public static final int STD_VIDEO_H264_LEVEL_IDC_5_1 = 8;
    public static final int STD_VIDEO_H264_LEVEL_IDC_5_2 = 9;
    public static final int STD_VIDEO_H264_LEVEL_IDC_6_0 = 10;
    public static final int STD_VIDEO_H264_LEVEL_IDC_6_1 = 11;
    public static final int STD_VIDEO_H264_LEVEL_IDC_6_2 = 12;
    public static final int STD_VIDEO_H264_LEVEL_IDC_INVALID = Integer.MAX_VALUE;
    ...
    public static final int STD_VIDEO_H265_SLICE_TYPE_INVALID = Integer.MAX_VALUE;
    ...
    public static final int STD_VIDEO_H265_PICTURE_TYPE_INVALID = Integer.MAX_VALUE;
    ...
    public static final int STD_VIDEO_H265_ASPECT_RATIO_IDC_INVALID = Integer.MAX_VALUE;
    public static final int VK_STD_VULKAN_VIDEO_CODEC_H265_DECODE_SPEC_VERSION = 0;
    public static final java.lang.String VK_STD_VULKAN_VIDEO_CODEC_H265_DECODE_EXTENSION_NAME = "VK_STD_vulkan_video_codec_h265_decode";
    public static final int STD_VIDEO_DECODE_H265_REF_PIC_SET_LIST_SIZE = 8;
    public static final int VK_STD_VULKAN_VIDEO_CODEC_H265_ENCODE_SPEC_VERSION = 0;
    public static final java.lang.String VK_STD_VULKAN_VIDEO_CODEC_H265_ENCODE_EXTENSION_NAME = "VK_STD_vulkan_video_codec_h265_encode";
    public static final int STD_VIDEO_ENCODE_H265_LUMA_LIST_SIZE = 15;
    public static final int STD_VIDEO_ENCODE_H265_CHROMA_LIST_SIZE = 15;
    public static final int STD_VIDEO_ENCODE_H265_CHROMA_LISTS_NUM = 2;
    ...
    static {
            ...
            org.lwjgl.vulkan.video.STDVulkanVideoCodecH265.VK_STD_VULKAN_VIDEO_CODEC_H265_DECODE_SPEC_VERSION = r0
            r0 = 0
            r1 = 9
            r2 = 12
            int r0 = org.lwjgl.vulkan.video.STDVulkanVideo.VK_MAKE_VIDEO_STD_VERSION(r0, r1, r2)
            org.lwjgl.vulkan.video.STDVulkanVideoCodecH265.VK_STD_VULKAN_VIDEO_CODEC_H265_ENCODE_SPEC_VERSION = r0
            return
    }
}
