...
/* JADX WARN: Classes with same name are omitted, all sources:
  DroidBridge.Launcher-v0.3.9.apk:assets/components/lwjgl3.3.3/lwjgl-glfw-classes.jar:org/lwjgl/vulkan/video/STDVulkanVideoCodecH264.class
  DroidBridge.Launcher-v0.3.9.apk:assets/components/lwjgl3.4.1/lwjgl-glfw-classes.jar:org/lwjgl/vulkan/video/STDVulkanVideoCodecH264.class
 */
/* JADX INFO: loaded from: DroidBridge.Launcher-v0.3.9.apk:assets/components/lwjgl3.3.3/lwjgl-glfw-classes.jar:org/lwjgl/vulkan/video/STDVulkanVideoCodecH264.class */
public final class STDVulkanVideoCodecH264 {
    ...
    public static final int STD_VIDEO_H264_NO_REFERENCE_PICTURE = 255;
    ...
    public static final int STD_VIDEO_H264_CHROMA_FORMAT_IDC_INVALID = Integer.MAX_VALUE;
    ...
    public static final int STD_VIDEO_H264_PROFILE_IDC_INVALID = Integer.MAX_VALUE;
    ...
    public static final int STD_VIDEO_H264_POC_TYPE_INVALID = Integer.MAX_VALUE;
    ...
    public static final int STD_VIDEO_H264_ASPECT_RATIO_IDC_INVALID = Integer.MAX_VALUE;
    ...
    public static final int STD_VIDEO_H264_WEIGHTED_BIPRED_IDC_INVALID = Integer.MAX_VALUE;
    ...
    public static final int STD_VIDEO_H264_MODIFICATION_OF_PIC_NUMS_IDC_INVALID = Integer.MAX_VALUE;
    ...
    public static final int STD_VIDEO_H264_MEM_MGMT_CONTROL_OP_INVALID = Integer.MAX_VALUE;
    ...
    public static final int STD_VIDEO_H264_CABAC_INIT_IDC_INVALID = Integer.MAX_VALUE;
    ...
    public static final int STD_VIDEO_H264_DISABLE_DEBLOCKING_FILTER_IDC_INVALID = Integer.MAX_VALUE;
    ...
    public static final int STD_VIDEO_H264_SLICE_TYPE_INVALID = Integer.MAX_VALUE;
    ...
    public static final int STD_VIDEO_H264_PICTURE_TYPE_INVALID = Integer.MAX_VALUE;
    ...
    public static final int STD_VIDEO_H264_NON_VCL_NALU_TYPE_INVALID = Integer.MAX_VALUE;
    public static final int VK_STD_VULKAN_VIDEO_CODEC_H264_DECODE_SPEC_VERSION = 0;
    public static final java.lang.String VK_STD_VULKAN_VIDEO_CODEC_H264_DECODE_EXTENSION_NAME = "VK_STD_vulkan_video_codec_h264_decode";
    ...
    public static final int VK_STD_VULKAN_VIDEO_CODEC_H264_ENCODE_SPEC_VERSION = 0;
    public static final java.lang.String VK_STD_VULKAN_VIDEO_CODEC_H264_ENCODE_EXTENSION_NAME = "VK_STD_vulkan_video_codec_h264_encode";
    ...
    static {
            ...
            org.lwjgl.vulkan.video.STDVulkanVideoCodecH264.VK_STD_VULKAN_VIDEO_CODEC_H264_DECODE_SPEC_VERSION = r0
            r0 = 0
            r1 = 9
            r2 = 11
            int r0 = org.lwjgl.vulkan.video.STDVulkanVideo.VK_MAKE_VIDEO_STD_VERSION(r0, r1, r2)
            org.lwjgl.vulkan.video.STDVulkanVideoCodecH264.VK_STD_VULKAN_VIDEO_CODEC_H264_ENCODE_SPEC_VERSION = r0
            return
    }
}
