...
/* JADX WARN: Classes with same name are omitted, all sources:
  DroidBridge.Launcher-v0.3.9.apk:assets/components/lwjgl3.3.3/lwjgl-glfw-classes.jar:org/lwjgl/vulkan/KHRExternalSemaphoreCapabilities.class
  DroidBridge.Launcher-v0.3.9.apk:assets/components/lwjgl3.4.1/lwjgl-glfw-classes.jar:org/lwjgl/vulkan/KHRExternalSemaphoreCapabilities.class
 */
/* JADX INFO: loaded from: DroidBridge.Launcher-v0.3.9.apk:assets/components/lwjgl3.3.3/lwjgl-glfw-classes.jar:org/lwjgl/vulkan/KHRExternalSemaphoreCapabilities.class */
public class KHRExternalSemaphoreCapabilities {
    ...
    public static final java.lang.String VK_KHR_EXTERNAL_SEMAPHORE_CAPABILITIES_EXTENSION_NAME = "VK_KHR_external_semaphore_capabilities";
    ...
    public static void nvkGetPhysicalDeviceExternalSemaphorePropertiesKHR(org.lwjgl.vulkan.VkPhysicalDevice r9, long r10, long r12) {
            r0 = r9
            org.lwjgl.vulkan.VKCapabilitiesInstance r0 = r0.getCapabilities()
            long r0 = r0.vkGetPhysicalDeviceExternalSemaphorePropertiesKHR
            r14 = r0
    ...
    public static void vkGetPhysicalDeviceExternalSemaphorePropertiesKHR(org.lwjgl.vulkan.VkPhysicalDevice r6, @org.lwjgl.system.NativeType("VkPhysicalDeviceExternalSemaphoreInfo const *") org.lwjgl.vulkan.VkPhysicalDeviceExternalSemaphoreInfo r7, @org.lwjgl.system.NativeType("VkExternalSemaphoreProperties *") org.lwjgl.vulkan.VkExternalSemaphoreProperties r8) {
            r0 = r6
            r1 = r7
            long r1 = r1.address()
            r2 = r8
            long r2 = r2.address()
            nvkGetPhysicalDeviceExternalSemaphorePropertiesKHR(r0, r1, r2)
            return
    }
}
