...
/* JADX WARN: Classes with same name are omitted, all sources:
  DroidBridge.Launcher-v0.3.9.apk:assets/components/lwjgl3.3.3/lwjgl-glfw-classes.jar:org/lwjgl/system/linux/liburing/LibIOURing.class
  DroidBridge.Launcher-v0.3.9.apk:assets/components/lwjgl3.4.1/lwjgl-glfw-classes.jar:org/lwjgl/system/linux/liburing/LibIOURing.class
 */
/* JADX INFO: loaded from: DroidBridge.Launcher-v0.3.9.apk:assets/components/lwjgl3.3.3/lwjgl-glfw-classes.jar:org/lwjgl/system/linux/liburing/LibIOURing.class */
public class LibIOURing {
    ...
    public static final long IORING_OFF_CQ_RING = 134217728;
    public static final long IORING_OFF_SQES = 268435456;
    ...
    public static int io_uring_setup(@org.lwjgl.system.NativeType("unsigned") int r4, @org.lwjgl.system.NativeType("struct io_uring_params *") org.lwjgl.system.linux.liburing.IOURingParams r5) {
            r0 = r4
            r1 = r5
            long r1 = r1.address()
    ...
    public static native int nio_uring_register(int r0, int r1, long r2, int r4);

    public static int io_uring_register(int r6, @org.lwjgl.system.NativeType("unsigned") int r7, @org.lwjgl.system.NativeType("void *") long r8, @org.lwjgl.system.NativeType("unsigned") int r10) {
            r0 = r6
            r1 = r7
            r2 = r8
            r3 = r10
            int r0 = nio_uring_register(r0, r1, r2, r3)
            return r0
    }

    public static native int nio_uring_enter2(int r0, int r1, int r2, int r3, long r4, int r6);

    public static int io_uring_enter2(int r8, @org.lwjgl.system.NativeType("unsigned") int r9, @org.lwjgl.system.NativeType("unsigned") int r10, @org.lwjgl.system.NativeType("unsigned") int r11, @org.lwjgl.system.NativeType("sigset_t *") long r12, int r14) {
            r0 = r8
            r1 = r9
            r2 = r10
            r3 = r11
    ...
    public static int io_uring_enter(int r7, @org.lwjgl.system.NativeType("unsigned") int r8, @org.lwjgl.system.NativeType("unsigned") int r9, @org.lwjgl.system.NativeType("unsigned") int r10, @org.lwjgl.system.NativeType("sigset_t *") long r11) {
            r0 = r7
            r1 = r8
            r2 = r9
            r3 = r10
