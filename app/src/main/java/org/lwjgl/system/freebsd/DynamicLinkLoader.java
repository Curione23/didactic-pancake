...
/* JADX INFO: loaded from: DroidBridge.Launcher-v0.3.9.apk:assets/components/lwjgl3.4.1/lwjgl-glfw-classes.jar:org/lwjgl/system/freebsd/DynamicLinkLoader.class */
public class DynamicLinkLoader {
    ...
    public static long dlopen(@org.lwjgl.system.NativeType("char const *") java.nio.ByteBuffer r4, int r5) {
    ...
    @org.lwjgl.system.NativeType("void *")
    public static long dlopen(@org.lwjgl.system.NativeType("char const *") java.lang.CharSequence r4, int r5) {
