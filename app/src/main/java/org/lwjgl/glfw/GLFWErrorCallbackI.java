...
/* JADX WARN: Classes with same name are omitted, all sources:
  DroidBridge.Launcher-v0.3.9.apk:assets/components/lwjgl3.3.3/lwjgl-glfw-classes.jar:org/lwjgl/glfw/GLFWErrorCallbackI.class
  DroidBridge.Launcher-v0.3.9.apk:assets/components/lwjgl3.4.1/lwjgl-glfw-classes.jar:org/lwjgl/glfw/GLFWErrorCallbackI.class
 */
/* JADX INFO: loaded from: DroidBridge.Launcher-v0.3.9.apk:assets/components/lwjgl3.3.3/lwjgl-glfw-classes.jar:org/lwjgl/glfw/GLFWErrorCallbackI.class */
@java.lang.FunctionalInterface
@org.lwjgl.system.NativeType("GLFWerrorfun")
public interface GLFWErrorCallbackI extends org.lwjgl.system.CallbackI {
    ...
    default org.lwjgl.system.libffi.FFICIF getCallInterface() {
            r2 = this;
            org.lwjgl.system.libffi.FFICIF r0 = org.lwjgl.glfw.GLFWErrorCallbackI.CIF
            return r0
    }
    ...
    default void callback(long r8, long r10) {
            ...
            r2 = r10
            int r3 = org.lwjgl.glfw.GLFWErrorCallbackI.POINTER_SIZE
            long r3 = (long) r3
            long r2 = r2 + r3
    ...
    void invoke(int r1, @org.lwjgl.system.NativeType("char *") long r2);
    ...
    static {
            ...
            org.lwjgl.glfw.GLFWErrorCallbackI.CIF = r0
            return
    }
}
