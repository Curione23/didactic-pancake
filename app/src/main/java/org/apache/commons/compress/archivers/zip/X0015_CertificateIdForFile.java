...
public class X0015_CertificateIdForFile extends org.apache.commons.compress.archivers.zip.PKWareExtraHeader {
    ...
    static {
            ...
            r1 = 21
            r0.<init>(r1)
            org.apache.commons.compress.archivers.zip.X0015_CertificateIdForFile.HEADER_ID = r0
            return
    }

    public X0015_CertificateIdForFile() {
            r1 = this;
            org.apache.commons.compress.archivers.zip.ZipShort r0 = org.apache.commons.compress.archivers.zip.X0015_CertificateIdForFile.HEADER_ID
            r1.<init>(r0)
            return
    }
    ...
    public void parseFromCentralDirectoryData(byte[] r2, int r3, int r4) throws java.util.zip.ZipException {
            ...
            super.parseFromCentralDirectoryData(r2, r3, r4)
