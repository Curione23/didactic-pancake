...
public class SuperMethodRefForm extends org.apache.commons.compress.harmony.unpack200.bytecode.forms.ClassSpecificReferenceForm {
    public SuperMethodRefForm(int r1, java.lang.String r2, int[] r3) {
            r0 = this;
            r0.<init>(r1, r2, r3)
            return
    }
    ...
    protected java.lang.String context(org.apache.commons.compress.harmony.unpack200.bytecode.OperandManager r1) {
            r0 = this;
            java.lang.String r1 = r1.getSuperClass()
            return r1
    }
